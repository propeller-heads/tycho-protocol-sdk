...
/// @title Curve Finance StableSwap Adapter
contract CurveStableSwapAdapter is ISwapAdapter {
    ...
    /// @notice Calculates pool prices for specified amounts. We use as amount
