---
description: Practical guide on writing a VM level indexing integration.
---

# VM Integration

Our indexing integrations use the Streamingfasts Substreams to transform raw blockchain data into higher level data streams. This is done by implementing a Rust module that is compiled into a SPKG file and then loaded by the Substreams server.
...
1.  Install [Rust](https://www.rust-lang.org/tools/install), you can do so with the following command:
    ...
    ```
2.  Install [Substreams CLI](https://substreams.streamingfast.io/getting-started/installing-the-cli), you can either use brew:
...
_Note: Internally we are referring to our indexing library as `Tycho`, which is why our protobuf files are under the `proto/tycho` directory._
...
_This is the actual integration code that you will be writing!_
...
Read our [Substreams README.md](../../../substreams/) for more information on how to write the Rust module.
