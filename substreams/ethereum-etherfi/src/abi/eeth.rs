...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct EethOperatingAdminRole {}
    impl EethOperatingAdminRole {
        const METHOD_ID: [u8; 4] = [20u8, 108u8, 168u8, 221u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for EethOperatingAdminRole {
        const NAME: &'static str = "EETH_OPERATING_ADMIN_ROLE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
