...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for DeprecatedEEthliquidStakingOpened {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DeprecatedRegulationsManager {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    pub struct AmountForShare {
        pub u_share: substreams::scalar::BigInt,
    }
    impl AmountForShare {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                match self.u_share.clone().to_bytes_be() {
                    (num_bigint::Sign::Plus, bytes) => bytes,
                    (num_bigint::Sign::NoSign, bytes) => bytes,
                    (num_bigint::Sign::Minus, _) => {
                        panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for AmountForShare {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct BatchApproveRegistration {
        pub u_validator_ids: Vec<substreams::scalar::BigInt>,
        pub u_pub_key: Vec<Vec<u8>>,
        pub u_signature: Vec<Vec<u8>>,
    }
    ...
    impl BatchCancelDepositByAdmin {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_bnft_staker)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    pub struct BatchDepositAsBnftHolder1 {
        pub u_candidate_bid_ids: Vec<substreams::scalar::BigInt>,
        pub u_number_of_validators: substreams::scalar::BigInt,
        pub u_validator_id_to_share_safe_with: substreams::scalar::BigInt,
    }
    impl BatchDepositAsBnftHolder1 {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                u_validator_id_to_share_safe_with: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
                        .expect(INTERNAL_ERR)
    ...
    impl substreams_ethereum::Function for BatchDepositAsBnftHolder1 {
        const NAME: &'static str = "batchDepositAsBnftHolder1";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Function for BatchDepositAsBnftHolder2 {
        const NAME: &'static str = "batchDepositAsBnftHolder2";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Function for BatchDepositWithLiquidityPoolAsBnftHolder1 {
        const NAME: &'static str = "batchDepositWithLiquidityPoolAsBnftHolder1";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Function for BatchDepositWithLiquidityPoolAsBnftHolder2 {
        const NAME: &'static str = "batchDepositWithLiquidityPoolAsBnftHolder2";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    pub struct BatchRegisterAsBnftHolder {
        pub u_deposit_root: [u8; 32usize],
        pub u_validator_ids: Vec<substreams::scalar::BigInt>,
        pub u_register_validator_deposit_data: Vec<(Vec<u8>, Vec<u8>, [u8; 32usize], String)>,
        pub u_deposit_data_root_approval: Vec<[u8; 32usize]>,
        pub u_signatures_for_approval_deposit: Vec<Vec<u8>>,
    }
    impl BatchRegisterAsBnftHolder {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                u_validator_ids: values
                    ...
                    .collect(),
                u_register_validator_deposit_data: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_array()
                    .expect(INTERNAL_ERR)
                    ...
                    .collect(),
                u_deposit_data_root_approval: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_array()
                    .expect(INTERNAL_ERR)
                    ...
                    .collect(),
                u_signatures_for_approval_deposit: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_array()
                    .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::FixedBytes(self.u_deposit_root.as_ref().to_vec()),
                {
                    let v = self
                        .u_validator_ids
                        .iter()
                ...
                {
                    let v = self
                        .u_register_validator_deposit_data
                        .iter()
                        .map(|inner| {
                ...
                {
                    let v = self
                        .u_signatures_for_approval_deposit
                        .iter()
                        .map(|inner| ethabi::Token::Bytes(inner.clone()))
                        .collect();
                    ethabi::Token::Array(v)
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(Vec<u8>, substreams::scalar::BigInt)> for BnftHolders {
    ...
    impl Deposit3 {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_referral)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for DepositDataRootForApprovalDeposits {
    ...
    impl DepositToRecipient {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_recipient)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.u_amount.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for DepositToRecipient {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetTotalEtherClaimOf {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Initialize {
        pub u_e_eth_address: Vec<u8>,
        pub u_staking_manager_address: Vec<u8>,
        pub u_nodes_manager_address: Vec<u8>,
        pub u_membership_manager_address: Vec<u8>,
        pub u_t_nft_address: Vec<u8>,
        pub u_ether_fi_admin_contract: Vec<u8>,
        pub u_withdraw_request_nft: Vec<u8>,
    }
    impl Initialize {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                u_e_eth_address: values
                    ...
                    .as_bytes()
                    .to_vec(),
                u_staking_manager_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                    .as_bytes()
                    .to_vec(),
                u_nodes_manager_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                    .as_bytes()
                    .to_vec(),
                u_membership_manager_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                ...
                u_t_nft_address: values
                    ...
                    .as_bytes()
                    .to_vec(),
                u_ether_fi_admin_contract: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_e_eth_address)),
                ethabi::Token::Address(ethabi::Address::from_slice(
                    &self.u_staking_manager_address,
                )),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_nodes_manager_address)),
                ethabi::Token::Address(ethabi::Address::from_slice(
                    &self.u_membership_manager_address,
                )),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_t_nft_address)),
                ethabi::Token::Address(ethabi::Address::from_slice(
                    &self.u_ether_fi_admin_contract,
                )),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_withdraw_request_nft)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    pub struct InitializeOnUpgrade {
        pub u_auction_manager: Vec<u8>,
        pub u_liquifier: Vec<u8>,
    }
    impl InitializeOnUpgrade {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_auction_manager)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.u_liquifier)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for NumPendingDeposits {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Rebase {
        pub u_accrued_rewards: substreams::scalar::BigInt,
    }
    impl Rebase {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values =
                ethabi::decode(&[ethabi::ParamType::Int(128usize)], maybe_data.unwrap())
                    .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                u_accrued_rewards: {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for RequestWithdraw {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl RequestWithdrawWithPermit {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Tuple(vec![
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.u_permit.0.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.u_permit.1.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.u_permit.2.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::FixedBytes(self.u_permit.3.as_ref().to_vec()),
                    ethabi::Token::FixedBytes(self.u_permit.4.as_ref().to_vec()),
                ]),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl SetRestakeBnftDeposits {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Bool(self.u_restake.clone())]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    pub struct SetStakingTargetWeights {
        pub u_e_eth_weight: substreams::scalar::BigInt,
        pub u_ether_fan_weight: substreams::scalar::BigInt,
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for SharesForAmount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TotalValueInLp {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TotalValueOutOfLp {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl UpdateAdmin {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Bool(self.u_is_admin.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl UpdateBnftMode {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Bool(self.u_is_lp_bnft_holder.clone())]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    impl UpdateWhitelistStatus {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Bool(self.u_value.clone())]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    impl UpdateWhitelistedAddresses {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Bool(self.u_value.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
...
pub mod events {
    ...
    impl BnftHolderDeregistered {
        const TOPIC_ID: [u8; 32] = [
            155u8, 108u8, 225u8, 38u8, 157u8, 136u8, 230u8, 12u8, 189u8, 184u8, 1u8, 80u8, 30u8,
            182u8, 178u8, 191u8, 148u8, 186u8, 225u8, 82u8, 60u8, 250u8, 108u8, 91u8, 255u8, 1u8,
            172u8, 1u8, 197u8, 121u8, 19u8, 208u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl BnftHolderRegistered {
        const TOPIC_ID: [u8; 32] = [
            59u8, 64u8, 146u8, 195u8, 79u8, 12u8, 47u8, 94u8, 228u8, 203u8, 241u8, 242u8, 10u8,
            140u8, 181u8, 193u8, 97u8, 231u8, 119u8, 86u8, 184u8, 241u8, 21u8, 32u8, 27u8, 53u8,
            196u8, 122u8, 239u8, 235u8, 103u8, 73u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Deposit {
        const TOPIC_ID: [u8; 32] = [
            162u8, 65u8, 250u8, 246u8, 46u8, 102u8, 206u8, 81u8, 141u8, 25u8, 52u8, 206u8, 76u8,
            147u8, 109u8, 128u8, 106u8, 2u8, 40u8, 155u8, 164u8, 131u8, 250u8, 194u8, 59u8, 235u8,
            140u8, 21u8, 117u8, 91u8, 233u8, 13u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Rebase {
        const TOPIC_ID: [u8; 32] = [
            17u8, 198u8, 191u8, 85u8, 134u8, 79u8, 248u8, 56u8, 39u8, 223u8, 113u8, 38u8, 37u8,
            215u8, 168u8, 14u8, 85u8, 131u8, 238u8, 240u8, 38u8, 73u8, 33u8, 2u8, 94u8, 124u8,
            210u8, 32u8, 3u8, 162u8, 21u8, 17u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl UpdatedSchedulingPeriod {
        const TOPIC_ID: [u8; 32] = [
            15u8, 99u8, 251u8, 69u8, 36u8, 112u8, 196u8, 251u8, 103u8, 19u8, 0u8, 30u8, 25u8,
            198u8, 80u8, 39u8, 34u8, 181u8, 118u8, 101u8, 162u8, 47u8, 203u8, 153u8, 253u8, 118u8,
            41u8, 99u8, 8u8, 144u8, 185u8, 214u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            let mut values =
                ethabi::decode(&[ethabi::ParamType::Uint(128usize)], log.data.as_ref())
                    .map_err(|e| format!("unable to decode log.data: {:?}", e))?;
            values.reverse();
            Ok(Self {
    ...
    impl UpdatedWhitelist {
        const TOPIC_ID: [u8; 32] = [
            12u8, 182u8, 65u8, 151u8, 17u8, 251u8, 193u8, 76u8, 18u8, 11u8, 126u8, 181u8, 224u8,
            43u8, 137u8, 123u8, 185u8, 26u8, 58u8, 180u8, 92u8, 140u8, 83u8, 87u8, 87u8, 146u8,
            185u8, 186u8, 163u8, 225u8, 116u8, 225u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl ValidatorApproved {
        const TOPIC_ID: [u8; 32] = [
            58u8, 69u8, 240u8, 105u8, 124u8, 42u8, 208u8, 66u8, 210u8, 139u8, 102u8, 121u8, 247u8,
            13u8, 105u8, 91u8, 144u8, 213u8, 84u8, 56u8, 223u8, 191u8, 63u8, 67u8, 164u8, 75u8,
            186u8, 157u8, 207u8, 6u8, 28u8, 25u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl ValidatorRegistered {
        const TOPIC_ID: [u8; 32] = [
            124u8, 110u8, 226u8, 193u8, 158u8, 169u8, 134u8, 154u8, 86u8, 238u8, 229u8, 230u8,
            143u8, 232u8, 83u8, 212u8, 229u8, 160u8, 23u8, 27u8, 12u8, 2u8, 32u8, 61u8, 9u8, 223u8,
            76u8, 65u8, 79u8, 232u8, 72u8, 130u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl ValidatorRegistrationCanceled {
        const TOPIC_ID: [u8; 32] = [
            147u8, 7u8, 143u8, 200u8, 226u8, 95u8, 138u8, 28u8, 241u8, 247u8, 38u8, 127u8, 200u8,
            185u8, 225u8, 100u8, 183u8, 154u8, 221u8, 66u8, 114u8, 148u8, 143u8, 120u8, 250u8,
            243u8, 16u8, 179u8, 120u8, 125u8, 127u8, 128u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl WhitelistStatusUpdated {
        const TOPIC_ID: [u8; 32] = [
            253u8, 218u8, 237u8, 187u8, 175u8, 149u8, 103u8, 138u8, 73u8, 21u8, 199u8, 217u8, 6u8,
            9u8, 153u8, 15u8, 33u8, 74u8, 21u8, 140u8, 255u8, 250u8, 74u8, 249u8, 90u8, 163u8,
            231u8, 186u8, 8u8, 124u8, 139u8, 7u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Withdraw {
        const TOPIC_ID: [u8; 32] = [
            185u8, 218u8, 63u8, 61u8, 246u8, 44u8, 40u8, 172u8, 166u8, 4u8, 128u8, 108u8, 198u8,
            238u8, 150u8, 120u8, 24u8, 157u8, 117u8, 145u8, 239u8, 81u8, 26u8, 119u8, 187u8, 4u8,
            15u8, 168u8, 54u8, 30u8, 158u8, 2u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
