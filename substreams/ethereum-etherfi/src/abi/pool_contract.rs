    ...
    pub mod functions {
                ...
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_bnft_staker),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_number_of_validators.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        pub struct BatchRegisterAsBnftHolder {
            ...
            pub u_validator_ids: Vec<substreams::scalar::BigInt>,
            pub u_register_validator_deposit_data: Vec<
        ...
        impl substreams_ethereum::Function
        for BatchRegisterWithLiquidityPoolAsBnftHolder {
        ...
        impl DeRegisterBnftHolder {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_b_nft_holder),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl Initialize {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_e_eth_address),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_staking_manager_address),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_nodes_manager_address),
                        ),
                        ethabi::Token::Address(
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_t_nft_address),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_ether_fi_admin_contract),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_withdraw_request_nft),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl InitializeOnUpgrade {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_auction_manager),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_liquifier),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl SetRestakeBnftDeposits {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::Bool(self.u_restake.clone())],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_e_eth_weight.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_ether_fan_weight.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl UpdateBnftMode {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::Bool(self.u_is_lp_bnft_holder.clone())],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
