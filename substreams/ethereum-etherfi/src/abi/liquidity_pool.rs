...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BatchRegister {
        pub deposit_data: Vec<(Vec<u8>, Vec<u8>, [u8; 32usize], String)>,
        pub bid_ids: Vec<substreams::scalar::BigInt>,
        pub ether_fi_node: Vec<u8>,
    }
    impl BatchRegister {
        const METHOD_ID: [u8; 4] = [30u8, 230u8, 101u8, 196u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.ether_fi_node),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for BatchRegister {
        const NAME: &'static str = "batchRegister";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BurnEEthShares {
        pub shares: substreams::scalar::BigInt,
    }
    impl BurnEEthShares {
        const METHOD_ID: [u8; 4] = [242u8, 197u8, 153u8, 138u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for BurnEEthShares {
        const NAME: &'static str = "burnEEthShares";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BurnEEthSharesForNonEthWithdrawal {
        pub amount_shares_to_burn: substreams::scalar::BigInt,
        pub withdrawal_value_in_eth: substreams::scalar::BigInt,
    }
    impl BurnEEthSharesForNonEthWithdrawal {
        const METHOD_ID: [u8; 4] = [124u8, 141u8, 196u8, 64u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.amount_shares_to_burn.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.withdrawal_value_in_eth.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for BurnEEthSharesForNonEthWithdrawal {
        const NAME: &'static str = "burnEEthSharesForNonETHWithdrawal";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ConfirmAndFundBeaconValidators {
        pub deposit_data: Vec<(Vec<u8>, Vec<u8>, [u8; 32usize], String)>,
        pub validator_size_wei: substreams::scalar::BigInt,
    }
    impl ConfirmAndFundBeaconValidators {
        const METHOD_ID: [u8; 4] = [186u8, 175u8, 241u8, 22u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.validator_size_wei.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for ConfirmAndFundBeaconValidators {
        const NAME: &'static str = "confirmAndFundBeaconValidators";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedAdmins {
        pub param0: Vec<u8>,
    }
    impl DeprecatedAdmins {
        const METHOD_ID: [u8; 4] = [252u8, 109u8, 254u8, 78u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeprecatedAdmins {
        const NAME: &'static str = "DEPRECATED_admins";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for DeprecatedAdmins {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedAuctionManager {}
    impl DeprecatedAuctionManager {
        const METHOD_ID: [u8; 4] = [23u8, 229u8, 30u8, 128u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DeprecatedAuctionManager {
        const NAME: &'static str = "DEPRECATED_auctionManager";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DeprecatedAuctionManager {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedBnftHolders {
        pub param0: substreams::scalar::BigInt,
    }
    impl DeprecatedBnftHolders {
        const METHOD_ID: [u8; 4] = [30u8, 149u8, 230u8, 14u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeprecatedBnftHolders {
        const NAME: &'static str = "DEPRECATED_bnftHolders";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DeprecatedBnftHolders {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedSendExitRequests {
        pub validator_ids: Vec<substreams::scalar::BigInt>,
    }
    impl DeprecatedSendExitRequests {
        const METHOD_ID: [u8; 4] = [7u8, 22u8, 226u8, 66u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeprecatedSendExitRequests {
        const NAME: &'static str = "DEPRECATED_sendExitRequests";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedTnft {}
    impl DeprecatedTnft {
        const METHOD_ID: [u8; 4] = [214u8, 123u8, 143u8, 238u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DeprecatedTnft {
        const NAME: &'static str = "DEPRECATED_TNFT";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DeprecatedTnft {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedWhitelistEnabled {}
    impl DeprecatedWhitelistEnabled {
        const METHOD_ID: [u8; 4] = [115u8, 70u8, 241u8, 170u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DeprecatedWhitelistEnabled {
        const NAME: &'static str = "DEPRECATED_whitelistEnabled";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for DeprecatedWhitelistEnabled {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct DeprecatedWhitelisted {
        pub param0: Vec<u8>,
    }
    impl DeprecatedWhitelisted {
        const METHOD_ID: [u8; 4] = [151u8, 149u8, 148u8, 115u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for DeprecatedWhitelisted {
        const NAME: &'static str = "DEPRECATED_whitelisted";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for DeprecatedWhitelisted {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct EtherFiRedemptionManager {}
    impl EtherFiRedemptionManager {
        const METHOD_ID: [u8; 4] = [220u8, 191u8, 182u8, 195u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for EtherFiRedemptionManager {
        const NAME: &'static str = "etherFiRedemptionManager";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for EtherFiRedemptionManager {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct InitializeVTwoDotFourNine {
        pub role_registry: Vec<u8>,
        pub ether_fi_redemption_manager: Vec<u8>,
    }
    impl InitializeVTwoDotFourNine {
        const METHOD_ID: [u8; 4] = [70u8, 212u8, 183u8, 20u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            Ok(Self {
                role_registry: values
                    ...
                    .as_bytes()
                    .to_vec(),
                ether_fi_redemption_manager: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.role_registry),
                    ),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.ether_fi_redemption_manager),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for InitializeVTwoDotFourNine {
        const NAME: &'static str = "initializeVTwoDotFourNine";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct LiquidityPoolAdminRole {}
    impl LiquidityPoolAdminRole {
        const METHOD_ID: [u8; 4] = [14u8, 169u8, 232u8, 82u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for LiquidityPoolAdminRole {
        const NAME: &'static str = "LIQUIDITY_POOL_ADMIN_ROLE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]>
    for LiquidityPoolAdminRole {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct LiquidityPoolValidatorApproverRole {}
    impl LiquidityPoolValidatorApproverRole {
        const METHOD_ID: [u8; 4] = [6u8, 190u8, 156u8, 83u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for LiquidityPoolValidatorApproverRole {
        const NAME: &'static str = "LIQUIDITY_POOL_VALIDATOR_APPROVER_ROLE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]>
    for LiquidityPoolValidatorApproverRole {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PayProtocolFees {
        pub protocol_fees: substreams::scalar::BigInt,
    }
    impl PayProtocolFees {
        const METHOD_ID: [u8; 4] = [25u8, 145u8, 194u8, 37u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.protocol_fees.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for PayProtocolFees {
        const NAME: &'static str = "payProtocolFees";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RegisterValidatorSpawner {
        pub user: Vec<u8>,
    }
    impl RegisterValidatorSpawner {
        const METHOD_ID: [u8; 4] = [86u8, 241u8, 25u8, 155u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for RegisterValidatorSpawner {
        const NAME: &'static str = "registerValidatorSpawner";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl RoleRegistry {
        const METHOD_ID: [u8; 4] = [8u8, 199u8, 50u8, 89u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for RoleRegistry {
        const NAME: &'static str = "roleRegistry";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for RoleRegistry {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetValidatorSizeWei {
        pub validator_size_wei: substreams::scalar::BigInt,
    }
    impl SetValidatorSizeWei {
        const METHOD_ID: [u8; 4] = [97u8, 110u8, 108u8, 27u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetValidatorSizeWei {
        const NAME: &'static str = "setValidatorSizeWei";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UnregisterValidatorSpawner {
        pub user: Vec<u8>,
    }
    impl UnregisterValidatorSpawner {
        const METHOD_ID: [u8; 4] = [21u8, 143u8, 143u8, 89u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for UnregisterValidatorSpawner {
        const NAME: &'static str = "unregisterValidatorSpawner";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorSizeWei {}
    impl ValidatorSizeWei {
        const METHOD_ID: [u8; 4] = [40u8, 169u8, 71u8, 217u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for ValidatorSizeWei {
        const NAME: &'static str = "validatorSizeWei";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl ValidatorSpawner {
        const METHOD_ID: [u8; 4] = [8u8, 6u8, 26u8, 235u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ValidatorSpawner {
        const NAME: &'static str = "validatorSpawner";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for ValidatorSpawner {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct EEthSharesBurnedForNonEthWithdrawal {
        pub amount_shares_to_burn: substreams::scalar::BigInt,
        pub withdrawal_value_in_eth: substreams::scalar::BigInt,
    }
    impl EEthSharesBurnedForNonEthWithdrawal {
        const TOPIC_ID: [u8; 32] = [
            136u8,
            138u8,
            36u8,
    ...
    impl substreams_ethereum::Event for EEthSharesBurnedForNonEthWithdrawal {
        const NAME: &'static str = "EEthSharesBurnedForNonETHWithdrawal";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for ProtocolFeePaid {
        const NAME: &'static str = "ProtocolFeePaid";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UpdatedFeeRecipient {
        pub new_fee_recipient: Vec<u8>,
    }
    impl UpdatedFeeRecipient {
        const TOPIC_ID: [u8; 32] = [
            191u8,
            84u8,
            6u8,
    ...
    impl substreams_ethereum::Event for UpdatedFeeRecipient {
        const NAME: &'static str = "UpdatedFeeRecipient";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UpdatedTreasury {
        pub new_treasury: Vec<u8>,
    }
    impl UpdatedTreasury {
        const TOPIC_ID: [u8; 32] = [
            166u8,
            223u8,
            72u8,
    ...
    impl substreams_ethereum::Event for UpdatedTreasury {
        const NAME: &'static str = "UpdatedTreasury";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorExitRequested {
        pub validator_id: substreams::scalar::BigInt,
    }
    impl ValidatorExitRequested {
        const TOPIC_ID: [u8; 32] = [
            51u8,
            155u8,
            35u8,
    ...
    impl substreams_ethereum::Event for ValidatorExitRequested {
        const NAME: &'static str = "ValidatorExitRequested";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorSpawnerRegistered {
        pub user: Vec<u8>,
    }
    impl ValidatorSpawnerRegistered {
        const TOPIC_ID: [u8; 32] = [
            139u8,
            239u8,
            136u8,
    ...
    impl substreams_ethereum::Event for ValidatorSpawnerRegistered {
        const NAME: &'static str = "ValidatorSpawnerRegistered";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ValidatorSpawnerUnregistered {
        pub user: Vec<u8>,
    }
    impl ValidatorSpawnerUnregistered {
        const TOPIC_ID: [u8; 32] = [
            138u8,
            90u8,
            254u8,
    ...
    impl substreams_ethereum::Event for ValidatorSpawnerUnregistered {
        const NAME: &'static str = "ValidatorSpawnerUnregistered";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
