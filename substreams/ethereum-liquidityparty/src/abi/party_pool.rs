...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>> for Burn {
        fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
            Self::output(data)
        }
    }
    ...
    impl BurnSwap {
        const METHOD_ID: [u8; 4] = [73u8, 30u8, 121u8, 152u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>> for Denominators {
        fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
            Self::output(data)
        }
    }
    ...
    impl Fee {
        const METHOD_ID: [u8; 4] = [147u8, 159u8, 94u8, 164u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>> for Fees {
        fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for FlashFeePpm {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for InitialMint {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Kappa {}
    impl Kappa {
        const METHOD_ID: [u8; 4] = [107u8, 186u8, 63u8, 47u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Kappa {
        const NAME: &'static str = "kappa";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Kappa {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for NumTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Swap {
        ...
        pub limit_price: substreams::scalar::BigInt,
        pub deadline: substreams::scalar::BigInt,
        pub unwrap: bool,
        pub cb_data: Vec<u8>,
    }
    impl Swap {
        const METHOD_ID: [u8; 4] = [112u8, 48u8, 84u8, 82u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                {
                    let non_full_signed_bytes = self.limit_price.to_signed_bytes_be();
    ...
    impl SwapAmounts {
        const METHOD_ID: [u8; 4] = [213u8, 22u8, 184u8, 198u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl SwapMint {
        const METHOD_ID: [u8; 4] = [203u8, 113u8, 127u8, 58u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl SwapToLimit {
        const METHOD_ID: [u8; 4] = [66u8, 100u8, 200u8, 188u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SwapToLimit {
        const NAME: &'static str = "swapToLimit";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    impl Burn {
        const TOPIC_ID: [u8; 32] = [
            63u8, 132u8, 237u8, 138u8, 161u8, 30u8, 214u8, 50u8, 222u8, 56u8, 4u8, 102u8, 8u8,
            50u8, 128u8, 180u8, 197u8, 218u8, 102u8, 143u8, 18u8, 105u8, 91u8, 8u8, 99u8, 109u8,
            120u8, 72u8, 234u8, 248u8, 150u8, 180u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl BurnSwap {
        const TOPIC_ID: [u8; 32] = [
            140u8, 1u8, 44u8, 97u8, 72u8, 232u8, 236u8, 195u8, 75u8, 134u8, 71u8, 33u8, 71u8, 13u8,
            204u8, 30u8, 147u8, 141u8, 22u8, 44u8, 73u8, 139u8, 125u8, 40u8, 150u8, 26u8, 138u8,
            120u8, 35u8, 140u8, 254u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                payer: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl Flash {
        const TOPIC_ID: [u8; 32] = [
            36u8, 158u8, 11u8, 246u8, 47u8, 249u8, 130u8, 52u8, 44u8, 106u8, 99u8, 146u8, 96u8,
            65u8, 105u8, 74u8, 34u8, 23u8, 150u8, 175u8, 75u8, 158u8, 186u8, 206u8, 252u8, 69u8,
            130u8, 61u8, 164u8, 35u8, 72u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl Killed {
        const TOPIC_ID: [u8; 32] = [
            15u8, 142u8, 238u8, 219u8, 196u8, 0u8, 253u8, 102u8, 134u8, 112u8, 53u8, 89u8, 245u8,
            141u8, 30u8, 97u8, 67u8, 253u8, 174u8, 213u8, 51u8, 241u8, 154u8, 134u8, 201u8, 61u8,
            103u8, 162u8, 254u8, 79u8, 179u8, 49u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl Mint {
        const TOPIC_ID: [u8; 32] = [
            107u8, 192u8, 85u8, 57u8, 103u8, 184u8, 187u8, 114u8, 121u8, 71u8, 201u8, 56u8, 85u8,
            92u8, 14u8, 6u8, 28u8, 63u8, 150u8, 182u8, 41u8, 147u8, 92u8, 143u8, 130u8, 164u8,
            59u8, 85u8, 141u8, 251u8, 28u8, 87u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl ProtocolFeesCollected {
        const TOPIC_ID: [u8; 32] = [
            213u8, 8u8, 254u8, 180u8, 175u8, 200u8, 18u8, 48u8, 184u8, 229u8, 220u8, 202u8, 134u8,
            90u8, 64u8, 90u8, 114u8, 219u8, 31u8, 146u8, 138u8, 80u8, 100u8, 248u8, 147u8, 171u8,
            34u8, 171u8, 86u8, 236u8, 37u8, 33u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Swap {
        const TOPIC_ID: [u8; 32] = [
            105u8, 80u8, 51u8, 156u8, 118u8, 97u8, 204u8, 164u8, 80u8, 40u8, 30u8, 83u8, 114u8,
            37u8, 37u8, 204u8, 19u8, 101u8, 144u8, 230u8, 34u8, 176u8, 17u8, 213u8, 190u8, 126u8,
            76u8, 73u8, 147u8, 104u8, 90u8, 108u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl SwapMint {
        const TOPIC_ID: [u8; 32] = [
            203u8, 244u8, 26u8, 6u8, 13u8, 120u8, 39u8, 25u8, 122u8, 206u8, 200u8, 229u8, 239u8,
            58u8, 191u8, 54u8, 214u8, 51u8, 231u8, 112u8, 96u8, 247u8, 174u8, 192u8, 57u8, 67u8,
            96u8, 141u8, 28u8, 216u8, 78u8, 190u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
