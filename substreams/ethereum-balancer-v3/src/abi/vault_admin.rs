...
pub mod functions {
    ...
    pub struct AddLiquidityToBuffer {
        pub wrapped_token: Vec<u8>,
        pub max_amount_underlying_in_raw: substreams::scalar::BigInt,
        pub max_amount_wrapped_in_raw: substreams::scalar::BigInt,
        pub exact_shares_to_issue: substreams::scalar::BigInt,
        pub shares_owner: Vec<u8>,
    }
    impl AddLiquidityToBuffer {
        const METHOD_ID: [u8; 4] = [226u8, 169u8, 43u8, 26u8];
        pub fn decode(
                ...
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.max_amount_underlying_in_raw.clone().to_bytes_be()
                            {
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.max_amount_wrapped_in_raw.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.exact_shares_to_issue.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.shares_owner),
                    ),
                ],
            );
    ...
    impl substreams_ethereum::Function for AddLiquidityToBuffer {
        const NAME: &'static str = "addLiquidityToBuffer";
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct AreBuffersPaused {}
    impl AreBuffersPaused {
        const METHOD_ID: [u8; 4] = [85u8, 203u8, 167u8, 254u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for AreBuffersPaused {
        const NAME: &'static str = "areBuffersPaused";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for AreBuffersPaused {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CollectAggregateFees {
        pub pool: Vec<u8>,
    }
    impl CollectAggregateFees {
        const METHOD_ID: [u8; 4] = [143u8, 74u8, 185u8, 202u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for CollectAggregateFees {
        const NAME: &'static str = "collectAggregateFees";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl DisableQuery {
        const METHOD_ID: [u8; 4] = [222u8, 26u8, 54u8, 166u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DisableQuery {
        const NAME: &'static str = "disableQuery";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DisableQueryPermanently {}
    impl DisableQueryPermanently {
        const METHOD_ID: [u8; 4] = [130u8, 20u8, 64u8, 242u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DisableQueryPermanently {
        const NAME: &'static str = "disableQueryPermanently";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl DisableRecoveryMode {
        const METHOD_ID: [u8; 4] = [191u8, 251u8, 120u8, 178u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl EnableQuery {
        const METHOD_ID: [u8; 4] = [224u8, 213u8, 86u8, 5u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for EnableQuery {
        const NAME: &'static str = "enableQuery";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl EnableRecoveryMode {
        const METHOD_ID: [u8; 4] = [220u8, 63u8, 87u8, 78u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferAsset {
        pub wrapped_token: Vec<u8>,
    }
    impl GetBufferAsset {
        const METHOD_ID: [u8; 4] = [3u8, 135u8, 88u8, 125u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetBufferAsset {
        const NAME: &'static str = "getBufferAsset";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetBufferAsset {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferBalance {
        pub token: Vec<u8>,
    }
    impl GetBufferBalance {
        const METHOD_ID: [u8; 4] = [64u8, 33u8, 254u8, 15u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetBufferBalance {
        const NAME: &'static str = "getBufferBalance";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferMinimumTotalSupply {}
    impl GetBufferMinimumTotalSupply {
        const METHOD_ID: [u8; 4] = [38u8, 168u8, 169u8, 145u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetBufferMinimumTotalSupply {
        const NAME: &'static str = "getBufferMinimumTotalSupply";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    for GetBufferMinimumTotalSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferOwnerShares {
        pub token: Vec<u8>,
        pub user: Vec<u8>,
    }
    impl GetBufferOwnerShares {
        const METHOD_ID: [u8; 4] = [147u8, 133u8, 227u8, 154u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetBufferOwnerShares {
        const NAME: &'static str = "getBufferOwnerShares";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetBufferOwnerShares {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferPeriodDuration {}
    impl GetBufferPeriodDuration {
        const METHOD_ID: [u8; 4] = [32u8, 193u8, 251u8, 122u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetBufferPeriodDuration {
        const NAME: &'static str = "getBufferPeriodDuration";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetBufferPeriodDuration {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferPeriodEndTime {}
    impl GetBufferPeriodEndTime {
        const METHOD_ID: [u8; 4] = [205u8, 81u8, 193u8, 47u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetBufferPeriodEndTime {
        const NAME: &'static str = "getBufferPeriodEndTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetBufferPeriodEndTime {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetBufferTotalShares {
        pub token: Vec<u8>,
    }
    impl GetBufferTotalShares {
        const METHOD_ID: [u8; 4] = [242u8, 120u8, 78u8, 7u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GetBufferTotalShares {
        const NAME: &'static str = "getBufferTotalShares";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetBufferTotalShares {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetMaximumPoolTokens {}
    impl GetMaximumPoolTokens {
        const METHOD_ID: [u8; 4] = [46u8, 66u8, 244u8, 213u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetMaximumPoolTokens {
        const NAME: &'static str = "getMaximumPoolTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetMaximumPoolTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetMinimumPoolTokens {}
    impl GetMinimumPoolTokens {
        const METHOD_ID: [u8; 4] = [168u8, 23u8, 91u8, 39u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetMinimumPoolTokens {
        const NAME: &'static str = "getMinimumPoolTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetMinimumPoolTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetMinimumTradeAmount {}
    impl GetMinimumTradeAmount {
        const METHOD_ID: [u8; 4] = [226u8, 203u8, 11u8, 160u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetMinimumTradeAmount {
        const NAME: &'static str = "getMinimumTradeAmount";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetMinimumTradeAmount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetMinimumWrapAmount {}
    impl GetMinimumWrapAmount {
        const METHOD_ID: [u8; 4] = [83u8, 149u8, 106u8, 162u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetMinimumWrapAmount {
        const NAME: &'static str = "getMinimumWrapAmount";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetMinimumWrapAmount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetPauseWindowEndTime {}
    impl GetPauseWindowEndTime {
        const METHOD_ID: [u8; 4] = [138u8, 141u8, 18u8, 58u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetPauseWindowEndTime {
        const NAME: &'static str = "getPauseWindowEndTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetPauseWindowEndTime {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetPoolMinimumTotalSupply {}
    impl GetPoolMinimumTotalSupply {
        const METHOD_ID: [u8; 4] = [208u8, 150u8, 90u8, 107u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetPoolMinimumTotalSupply {
        const NAME: &'static str = "getPoolMinimumTotalSupply";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for GetPoolMinimumTotalSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetVaultPausedState {}
    impl GetVaultPausedState {
        const METHOD_ID: [u8; 4] = [133u8, 200u8, 192u8, 21u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetVaultPausedState {
        const NAME: &'static str = "getVaultPausedState";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct InitializeBuffer {
        pub wrapped_token: Vec<u8>,
        pub amount_underlying_raw: substreams::scalar::BigInt,
        pub amount_wrapped_raw: substreams::scalar::BigInt,
        pub min_issued_shares: substreams::scalar::BigInt,
        pub shares_owner: Vec<u8>,
    }
    impl InitializeBuffer {
        const METHOD_ID: [u8; 4] = [101u8, 62u8, 179u8, 176u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.amount_underlying_raw.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.amount_wrapped_raw.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.min_issued_shares.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for InitializeBuffer {
        const NAME: &'static str = "initializeBuffer";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for InitializeBuffer {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct IsVaultPaused {}
    impl IsVaultPaused {
        const METHOD_ID: [u8; 4] = [9u8, 132u8, 1u8, 245u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for IsVaultPaused {
        const NAME: &'static str = "isVaultPaused";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsVaultPaused {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl PausePool {
        const METHOD_ID: [u8; 4] = [85u8, 172u8, 161u8, 236u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PauseVault {}
    impl PauseVault {
        const METHOD_ID: [u8; 4] = [158u8, 8u8, 121u8, 194u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PauseVault {
        const NAME: &'static str = "pauseVault";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PauseVaultBuffers {}
    impl PauseVaultBuffers {
        const METHOD_ID: [u8; 4] = [224u8, 133u8, 197u8, 168u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PauseVaultBuffers {
        const NAME: &'static str = "pauseVaultBuffers";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RemoveLiquidityFromBuffer {
        pub wrapped_token: Vec<u8>,
        pub shares_to_remove: substreams::scalar::BigInt,
        pub min_amount_underlying_out_raw: substreams::scalar::BigInt,
        pub min_amount_wrapped_out_raw: substreams::scalar::BigInt,
    }
    impl RemoveLiquidityFromBuffer {
        const METHOD_ID: [u8; 4] = [235u8, 199u8, 149u8, 92u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.shares_to_remove.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.min_amount_wrapped_out_raw.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for RemoveLiquidityFromBuffer {
        const NAME: &'static str = "removeLiquidityFromBuffer";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RemoveLiquidityFromBufferHook {
        pub wrapped_token: Vec<u8>,
        pub shares_to_remove: substreams::scalar::BigInt,
        pub min_amount_underlying_out_raw: substreams::scalar::BigInt,
        pub min_amount_wrapped_out_raw: substreams::scalar::BigInt,
    ...
    impl RemoveLiquidityFromBufferHook {
        const METHOD_ID: [u8; 4] = [93u8, 202u8, 205u8, 100u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for RemoveLiquidityFromBufferHook {
        const NAME: &'static str = "removeLiquidityFromBufferHook";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<
        (substreams::scalar::BigInt, substreams::scalar::BigInt),
    > for RemoveLiquidityFromBufferHook {
        fn output(
            data: &[u8],
        ) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
    ...
    impl SetProtocolFeeController {
        ...
        pub fn decode(
            ...
            values.reverse();
            Ok(Self {
                new_protocol_fee_controller: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.new_protocol_fee_controller),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetStaticSwapFeePercentage {
        pub pool: Vec<u8>,
        pub swap_fee_percentage: substreams::scalar::BigInt,
    }
    impl SetStaticSwapFeePercentage {
        const METHOD_ID: [u8; 4] = [209u8, 81u8, 38u8, 186u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetStaticSwapFeePercentage {
        const NAME: &'static str = "setStaticSwapFeePercentage";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl UnpausePool {
        const METHOD_ID: [u8; 4] = [242u8, 28u8, 56u8, 205u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UnpauseVault {}
    impl UnpauseVault {
        const METHOD_ID: [u8; 4] = [11u8, 117u8, 98u8, 190u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for UnpauseVault {
        const NAME: &'static str = "unpauseVault";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UnpauseVaultBuffers {}
    impl UnpauseVaultBuffers {
        const METHOD_ID: [u8; 4] = [185u8, 33u8, 43u8, 73u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for UnpauseVaultBuffers {
        const NAME: &'static str = "unpauseVaultBuffers";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UpdateAggregateSwapFeePercentage {
        pub pool: Vec<u8>,
        pub new_aggregate_swap_fee_percentage: substreams::scalar::BigInt,
    }
    impl UpdateAggregateSwapFeePercentage {
        const METHOD_ID: [u8; 4] = [94u8, 11u8, 6u8, 244u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            Ok(Self {
                pool: values
                    ...
                    .as_bytes()
                    .to_vec(),
                new_aggregate_swap_fee_percentage: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
                        .expect(INTERNAL_ERR)
    ...
    impl substreams_ethereum::Function for UpdateAggregateSwapFeePercentage {
        const NAME: &'static str = "updateAggregateSwapFeePercentage";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct UpdateAggregateYieldFeePercentage {
        pub pool: Vec<u8>,
        pub new_aggregate_yield_fee_percentage: substreams::scalar::BigInt,
    }
    impl UpdateAggregateYieldFeePercentage {
        const METHOD_ID: [u8; 4] = [226u8, 83u8, 103u8, 10u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            Ok(Self {
                pool: values
                    ...
                    .as_bytes()
                    .to_vec(),
                new_aggregate_yield_fee_percentage: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
                        .expect(INTERNAL_ERR)
    ...
    impl substreams_ethereum::Function for UpdateAggregateYieldFeePercentage {
        const NAME: &'static str = "updateAggregateYieldFeePercentage";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
