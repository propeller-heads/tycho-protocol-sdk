...
pub mod functions {
    ...
    impl AddLiquidity {
        ...
        ) -> Result<(Vec<substreams::scalar::BigInt>, substreams::scalar::BigInt, Vec<u8>), String>
        {
        ...
        pub fn call(
            &self,
            address: Vec<u8>,
        ) -> Option<(Vec<substreams::scalar::BigInt>, substreams::scalar::BigInt, Vec<u8>)>
        {
    ...
    impl RemoveLiquidity {
        ...
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<(substreams::scalar::BigInt, Vec<substreams::scalar::BigInt>, Vec<u8>), String>
        {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(
        ...
        pub fn call(
            &self,
            address: Vec<u8>,
        ) -> Option<(substreams::scalar::BigInt, Vec<substreams::scalar::BigInt>, Vec<u8>)>
        {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall { to_addr: address, data: self.encode() }],
...
pub mod events {
    ...
    pub struct PoolRegistered {
        ...
        pub hooks_config: (bool, bool, bool, bool, bool, bool, bool, bool, bool, bool, Vec<u8>),
