...
pub mod functions {
    ...
    impl AccumulateAsFees {
        const METHOD_ID: [u8; 4] = [240u8, 104u8, 44u8, 123u8];
        pub fn decode(
    ...
    impl CollectFees {
        const METHOD_ID: [u8; 4] = [129u8, 109u8, 213u8, 103u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ...
                    ethabi::Token::Tuple(
                        vec![
                            { let non_full_signed_bytes = self.bounds.0
                            ...
                            .as_ref())) }, { let non_full_signed_bytes = self.bounds.1
                            .to_signed_bytes_be(); let full_signed_bytes_init = if
                            non_full_signed_bytes[0] & 0x80 == 0x80 { 0xff } else { 0x00
                            }; let mut full_signed_bytes = [full_signed_bytes_init as u8;
                            32]; non_full_signed_bytes.into_iter().rev().enumerate()
    ...
    impl ExpirationTime {
        const METHOD_ID: [u8; 4] = [218u8, 40u8, 77u8, 204u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for ExpirationTime {
        const NAME: &'static str = "expirationTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl GetPoolFeesPerLiquidityInside {
        const METHOD_ID: [u8; 4] = [147u8, 64u8, 118u8, 82u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl InitializePool {
        const METHOD_ID: [u8; 4] = [85u8, 108u8, 130u8, 17u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl Swap {
        const METHOD_ID: [u8; 4] = [170u8, 55u8, 59u8, 111u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl UpdatePosition {
        const METHOD_ID: [u8; 4] = [165u8, 112u8, 111u8, 58u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
...
pub mod events {
    ...
    impl substreams_ethereum::Event for ProtocolFeesPaid {
        const NAME: &'static str = "ProtocolFeesPaid";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    pub struct Swapped {
        ...
        pub delta0: substreams::scalar::BigInt,
        pub delta1: substreams::scalar::BigInt,
        pub sqrt_ratio_after: substreams::scalar::BigInt,
        pub tick_after: substreams::scalar::BigInt,
        pub liquidity_after: substreams::scalar::BigInt,
    }
    impl Swapped {
        const TOPIC_ID: [u8; 32] = [
            21u8,
