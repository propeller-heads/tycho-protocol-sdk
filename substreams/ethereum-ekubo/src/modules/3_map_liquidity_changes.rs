...
use crate::pb::ekubo::{block_transaction_events::transaction_events::{pool_log::Event, PoolLog}, BlockTransactionEvents, LiquidityChange, LiquidityChangeType, LiquidityChanges};
        ...
        changes: block_tx_events
            ...
            .flat_map(|tx_events| {
                ...
                tx_events
                    .pool_logs
                    .into_iter()
                    .filter_map(move |log| maybe_liquidity_change(&log, current_tick_store)
                        .map(|partial| LiquidityChange {
...
fn maybe_liquidity_change(log: &PoolLog, current_tick_store: &StoreGetInt64) -> Option<PartialLiquidityChange> {
