...
use crate::pb::ekubo::block_transaction_events::transaction_events::pool_log::Event;
use crate::pb::ekubo::BlockTransactionEvents;
...
pub fn store_active_ticks(block_tx_events: BlockTransactionEvents, store: StoreSetInt64) {
    block_tx_events
        ...
        .filter_map(|log| maybe_tick(log.event.unwrap())
            .map(|tick| (
                log.pool_id.to_hex(),
                log.ordinal,
                tick,
