    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct RoleAssetManager {}
        impl RoleAssetManager {
            const METHOD_ID: [u8; 4] = [146u8, 189u8, 149u8, 234u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for RoleAssetManager {
            const NAME: &'static str = "roleAssetManager";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for RoleAssetManager {
            fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct RoleBntManager {}
        impl RoleBntManager {
            const METHOD_ID: [u8; 4] = [200u8, 120u8, 171u8, 51u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for RoleBntManager {
            const NAME: &'static str = "roleBNTManager";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for RoleBntManager {
            fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
                Self::output(data)
            }
        }
        ...
        impl WithdrawFunds {
            const METHOD_ID: [u8; 4] = [28u8, 32u8, 250u8, 221u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for FundsBurned {
            const NAME: &'static str = "FundsBurned";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
