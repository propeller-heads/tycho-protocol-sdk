...
pub mod functions {
    ...
    impl Borrow {
        const METHOD_ID: [u8; 4] = [97u8, 74u8, 57u8, 177u8];
    ...
    impl Initialize {
        const METHOD_ID: [u8; 4] = [39u8, 20u8, 155u8, 93u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl Payback {
        const METHOD_ID: [u8; 4] = [219u8, 226u8, 241u8, 111u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
...
pub mod events {
    ...
    pub struct LogBorrow {
        ...
        pub position_salt: [u8; 32usize],
        pub amount0: substreams::scalar::BigInt,
        pub amount1: substreams::scalar::BigInt,
        pub fee_accrued_token0: substreams::scalar::BigInt,
        pub fee_accrued_token1: substreams::scalar::BigInt,
        pub liquidity_increase_raw: substreams::scalar::BigInt,
    }
    impl LogBorrow {
        const TOPIC_ID: [u8; 32] = [
            150u8, 27u8, 56u8, 44u8, 212u8, 175u8, 222u8, 100u8, 76u8, 118u8, 57u8, 19u8, 180u8,
            106u8, 182u8, 48u8, 202u8, 136u8, 219u8, 223u8, 67u8, 51u8, 92u8, 219u8, 117u8, 113u8,
            135u8, 46u8, 199u8, 100u8, 103u8, 143u8,
        ];
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                user: ethabi::decode(&[ethabi::ParamType::Address], log.topics[3usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl substreams_ethereum::Event for LogBorrow {
        const NAME: &'static str = "LogBorrow";
    ...
    impl LogInitialize {
        const TOPIC_ID: [u8; 32] = [
            147u8, 174u8, 247u8, 255u8, 204u8, 74u8, 170u8, 134u8, 111u8, 156u8, 13u8, 82u8, 80u8,
            105u8, 83u8, 238u8, 178u8, 143u8, 97u8, 211u8, 154u8, 196u8, 213u8, 204u8, 61u8, 46u8,
            245u8, 148u8, 38u8, 232u8, 86u8, 3u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for LogInitialize {
        const NAME: &'static str = "LogInitialize";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    pub struct LogPayback {
        ...
        pub fee_accrued_token0: substreams::scalar::BigInt,
        pub fee_accrued_token1: substreams::scalar::BigInt,
        pub liquidity_decrease_raw: substreams::scalar::BigInt,
    }
    impl LogPayback {
        const TOPIC_ID: [u8; 32] = [
            26u8, 153u8, 87u8, 41u8, 34u8, 165u8, 90u8, 12u8, 48u8, 5u8, 96u8, 163u8, 200u8, 59u8,
            152u8, 139u8, 243u8, 92u8, 241u8, 75u8, 210u8, 162u8, 29u8, 20u8, 47u8, 127u8, 190u8,
            123u8, 21u8, 31u8, 120u8, 82u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl substreams_ethereum::Event for LogPayback {
        const NAME: &'static str = "LogPayback";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
