...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for BpowPrecision {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for CalcInGivenOut {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for CalcOutGivenIn {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for CalcSpotPrice {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetBalance {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetDenormalizedWeight {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetNormalizedWeight {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetNumTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetSpotPrice {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetSpotPriceSansFee {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetSwapFee {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for InitPoolSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxBoundTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxBpowBase {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxInRatio {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxOrderDuration {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxOutRatio {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxTotalWeight {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxWeight {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MinBalance {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MinBoundTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MinBpowBase {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MinWeight {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for SolutionSettlerDomainSeparator {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    impl Verify {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Tuple(vec![
                ...
                ethabi::Token::FixedBytes(self.order.6.as_ref().to_vec()),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                ...
                ethabi::Token::FixedBytes(self.order.8.as_ref().to_vec()),
                ethabi::Token::Bool(self.order.9.clone()),
                ethabi::Token::FixedBytes(self.order.10.as_ref().to_vec()),
                ethabi::Token::FixedBytes(self.order.11.as_ref().to_vec()),
            ])]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
...
pub mod events {
    ...
    impl LogCall {
        const TOPIC_ID: [u8; 32] = [
            37u8, 252u8, 225u8, 254u8, 1u8, 217u8, 178u8, 65u8, 253u8, 164u8, 11u8, 33u8, 82u8,
            221u8, 214u8, 244u8, 186u8, 6u8, 63u8, 207u8, 179u8, 194u8, 200u8, 29u8, 221u8, 248u8,
            78u8, 226u8, 13u8, 63u8, 52u8, 31u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                sig: {
                    ...
                    .map_err(|e| {
                        format!("unable to decode param 'sig' from topic of type 'bytes4': {:?}", e)
                    })?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_fixed_bytes()
    ...
    impl LogExit {
        const TOPIC_ID: [u8; 32] = [
            231u8, 76u8, 145u8, 85u8, 43u8, 100u8, 194u8, 226u8, 231u8, 189u8, 37u8, 86u8, 57u8,
            224u8, 4u8, 230u8, 147u8, 189u8, 62u8, 29u8, 1u8, 204u8, 51u8, 230u8, 86u8, 16u8,
            184u8, 106u8, 252u8, 193u8, 255u8, 237u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl LogJoin {
        const TOPIC_ID: [u8; 32] = [
            99u8, 152u8, 45u8, 241u8, 14u8, 253u8, 141u8, 250u8, 170u8, 160u8, 252u8, 199u8, 245u8,
            11u8, 45u8, 147u8, 183u8, 203u8, 162u8, 108u8, 204u8, 72u8, 173u8, 238u8, 40u8, 115u8,
            34u8, 13u8, 72u8, 93u8, 195u8, 154u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl LogSwap {
        const TOPIC_ID: [u8; 32] = [
            144u8, 143u8, 181u8, 238u8, 143u8, 22u8, 198u8, 188u8, 155u8, 195u8, 105u8, 9u8, 115u8,
            129u8, 159u8, 50u8, 164u8, 212u8, 177u8, 1u8, 136u8, 19u8, 69u8, 67u8, 200u8, 135u8,
            6u8, 224u8, 225u8, 212u8, 51u8, 120u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
