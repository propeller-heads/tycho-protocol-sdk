    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TwapObservationHistory {
            pub param0: substreams::scalar::BigInt,
        }
        impl TwapObservationHistory {
            const METHOD_ID: [u8; 4] = [39u8, 231u8, 56u8, 54u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
        ...
        impl substreams_ethereum::Function for TwapObservationHistory {
            const NAME: &'static str = "TWAPObservationHistory";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct CancelLongTermSwap {
            pub order_id: substreams::scalar::BigInt,
        }
        impl CancelLongTermSwap {
            const METHOD_ID: [u8; 4] = [31u8, 79u8, 91u8, 66u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for CancelLongTermSwap {
            const NAME: &'static str = "cancelLongTermSwap";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ExecuteVirtualOrders {
            pub block_timestamp: substreams::scalar::BigInt,
        }
        impl ExecuteVirtualOrders {
            const METHOD_ID: [u8; 4] = [46u8, 10u8, 227u8, 117u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.block_timestamp.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for ExecuteVirtualOrders {
            const NAME: &'static str = "executeVirtualOrders";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetAmountIn {
            const METHOD_ID: [u8; 4] = [17u8, 37u8, 241u8, 63u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetDetailedOrdersForUser {
            pub user: Vec<u8>,
            pub offset: substreams::scalar::BigInt,
            pub limit: substreams::scalar::BigInt,
        }
        impl GetDetailedOrdersForUser {
            const METHOD_ID: [u8; 4] = [135u8, 53u8, 63u8, 237u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetDetailedOrdersForUser {
            const NAME: &'static str = "getDetailedOrdersForUser";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetNextOrderId {}
        impl GetNextOrderId {
            const METHOD_ID: [u8; 4] = [120u8, 221u8, 2u8, 152u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetNextOrderId {
            const NAME: &'static str = "getNextOrderID";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOrderIDsForUser {
            pub user: Vec<u8>,
        }
        impl GetOrderIDsForUser {
            const METHOD_ID: [u8; 4] = [150u8, 16u8, 197u8, 241u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetOrderIDsForUser {
            const NAME: &'static str = "getOrderIDsForUser";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        for GetOrderIDsForUser {
            fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOrderIDsForUserLength {
            pub user: Vec<u8>,
        }
        impl GetOrderIDsForUserLength {
            const METHOD_ID: [u8; 4] = [117u8, 59u8, 253u8, 75u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetOrderIDsForUserLength {
            const NAME: &'static str = "getOrderIDsForUserLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetOrderIDsForUserLength {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetReserveAfterTwamm {
            pub block_timestamp: substreams::scalar::BigInt,
        }
        impl GetReserveAfterTwamm {
            const METHOD_ID: [u8; 4] = [188u8, 170u8, 100u8, 234u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetReserveAfterTwamm {
            const NAME: &'static str = "getReserveAfterTwamm";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwapHistoryLength {}
        impl GetTwapHistoryLength {
            const METHOD_ID: [u8; 4] = [127u8, 162u8, 238u8, 110u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetTwapHistoryLength {
            const NAME: &'static str = "getTWAPHistoryLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetTwapHistoryLength {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammOrder {
            pub order_id: substreams::scalar::BigInt,
        }
        impl GetTwammOrder {
            const METHOD_ID: [u8; 4] = [74u8, 220u8, 119u8, 194u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTwammOrder {
            const NAME: &'static str = "getTwammOrder";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammOrderProceeds {
            pub order_id: substreams::scalar::BigInt,
        }
        impl GetTwammOrderProceeds {
            const METHOD_ID: [u8; 4] = [72u8, 148u8, 197u8, 60u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTwammOrderProceeds {
            const NAME: &'static str = "getTwammOrderProceeds";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammOrderProceedsView {
            pub order_id: substreams::scalar::BigInt,
            pub block_timestamp: substreams::scalar::BigInt,
        }
        impl GetTwammOrderProceedsView {
            const METHOD_ID: [u8; 4] = [44u8, 132u8, 136u8, 218u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTwammOrderProceedsView {
            const NAME: &'static str = "getTwammOrderProceedsView";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammReserves {}
        impl GetTwammReserves {
            const METHOD_ID: [u8; 4] = [9u8, 76u8, 241u8, 73u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetTwammReserves {
            const NAME: &'static str = "getTwammReserves";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammRewardFactor {
            pub u_block_timestamp: substreams::scalar::BigInt,
        }
        impl GetTwammRewardFactor {
            const METHOD_ID: [u8; 4] = [67u8, 201u8, 144u8, 129u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_block_timestamp.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for GetTwammRewardFactor {
            const NAME: &'static str = "getTwammRewardFactor";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammSalesRateEnding {
            pub u_block_timestamp: substreams::scalar::BigInt,
        }
        impl GetTwammSalesRateEnding {
            const METHOD_ID: [u8; 4] = [66u8, 47u8, 255u8, 5u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetTwammSalesRateEnding {
            const NAME: &'static str = "getTwammSalesRateEnding";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTwammState {}
        impl GetTwammState {
            const METHOD_ID: [u8; 4] = [232u8, 82u8, 188u8, 46u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetTwammState {
            const NAME: &'static str = "getTwammState";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct LongTermSwapFrom0To1 {
            pub amount0_in: substreams::scalar::BigInt,
            pub number_of_time_intervals: substreams::scalar::BigInt,
        }
        impl LongTermSwapFrom0To1 {
            const METHOD_ID: [u8; 4] = [201u8, 115u8, 138u8, 13u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount0_in.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.number_of_time_intervals.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for LongTermSwapFrom0To1 {
            const NAME: &'static str = "longTermSwapFrom0To1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for LongTermSwapFrom0To1 {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct LongTermSwapFrom1To0 {
            pub amount1_in: substreams::scalar::BigInt,
            pub number_of_time_intervals: substreams::scalar::BigInt,
        }
        impl LongTermSwapFrom1To0 {
            const METHOD_ID: [u8; 4] = [129u8, 202u8, 121u8, 152u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amount1_in.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for LongTermSwapFrom1To0 {
            const NAME: &'static str = "longTermSwapFrom1To0";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct NewSwapsPaused {}
        impl NewSwapsPaused {
            const METHOD_ID: [u8; 4] = [31u8, 194u8, 250u8, 127u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for NewSwapsPaused {
            const NAME: &'static str = "newSwapsPaused";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for NewSwapsPaused {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct OrderIDsForUser {
            pub param0: Vec<u8>,
            pub param1: substreams::scalar::BigInt,
        }
        impl OrderIDsForUser {
            const METHOD_ID: [u8; 4] = [133u8, 42u8, 141u8, 190u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for OrderIDsForUser {
            const NAME: &'static str = "orderIDsForUser";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct OrderTimeInterval {}
        impl OrderTimeInterval {
            const METHOD_ID: [u8; 4] = [116u8, 143u8, 198u8, 59u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for OrderTimeInterval {
            const NAME: &'static str = "orderTimeInterval";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TogglePauseNewSwaps {}
        impl TogglePauseNewSwaps {
            const METHOD_ID: [u8; 4] = [150u8, 242u8, 145u8, 39u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TogglePauseNewSwaps {
            const NAME: &'static str = "togglePauseNewSwaps";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TwammReserve0 {}
        impl TwammReserve0 {
            const METHOD_ID: [u8; 4] = [14u8, 206u8, 114u8, 54u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TwammReserve0 {
            const NAME: &'static str = "twammReserve0";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TwammReserve1 {}
        impl TwammReserve1 {
            const METHOD_ID: [u8; 4] = [125u8, 49u8, 110u8, 40u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TwammReserve1 {
            const NAME: &'static str = "twammReserve1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TwammUpToDate {}
        impl TwammUpToDate {
            const METHOD_ID: [u8; 4] = [161u8, 70u8, 44u8, 25u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TwammUpToDate {
            const NAME: &'static str = "twammUpToDate";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for TwammUpToDate {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct WithdrawProceedsFromLongTermSwap {
            pub order_id: substreams::scalar::BigInt,
        }
        impl WithdrawProceedsFromLongTermSwap {
            const METHOD_ID: [u8; 4] = [129u8, 253u8, 10u8, 70u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn output_call(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<(bool, Vec<u8>, substreams::scalar::BigInt), String> {
                Self::output(call.return_data.as_ref())
            }
            pub fn output(
                data: &[u8],
            ...
            pub fn call(
                &self,
                address: Vec<u8>,
            ) -> Option<(bool, Vec<u8>, substreams::scalar::BigInt)> {
                use substreams_ethereum::pb::eth::rpc;
                let rpc_calls = rpc::RpcCalls {
                    calls: vec![
                        rpc::RpcCall { to_addr : address, data : self.encode(), }
        ...
        impl substreams_ethereum::Function for WithdrawProceedsFromLongTermSwap {
            const NAME: &'static str = "withdrawProceedsFromLongTermSwap";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<
            (bool, Vec<u8>, substreams::scalar::BigInt),
        > for WithdrawProceedsFromLongTermSwap {
            fn output(
                data: &[u8],
            ) -> Result<(bool, Vec<u8>, substreams::scalar::BigInt), String> {
                Self::output(data)
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct CancelLongTermOrder {
            pub addr: Vec<u8>,
            pub order_id: substreams::scalar::BigInt,
            pub sell_token: Vec<u8>,
            pub unsold_amount: substreams::scalar::BigInt,
            pub buy_token: Vec<u8>,
            pub purchased_amount: substreams::scalar::BigInt,
        }
        impl CancelLongTermOrder {
            const TOPIC_ID: [u8; 32] = [
                60u8,
                93u8,
                94u8,
        ...
        impl substreams_ethereum::Event for CancelLongTermOrder {
            const NAME: &'static str = "CancelLongTermOrder";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct LongTermSwap0To1 {
            pub addr: Vec<u8>,
            pub order_id: substreams::scalar::BigInt,
            pub amount0_in: substreams::scalar::BigInt,
            pub number_of_time_intervals: substreams::scalar::BigInt,
        }
        impl LongTermSwap0To1 {
            const TOPIC_ID: [u8; 32] = [
                153u8,
                113u8,
                41u8,
        ...
        impl substreams_ethereum::Event for LongTermSwap0To1 {
            const NAME: &'static str = "LongTermSwap0To1";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct LongTermSwap1To0 {
            pub addr: Vec<u8>,
            pub order_id: substreams::scalar::BigInt,
            pub amount1_in: substreams::scalar::BigInt,
            pub number_of_time_intervals: substreams::scalar::BigInt,
        }
        impl LongTermSwap1To0 {
            const TOPIC_ID: [u8; 32] = [
                225u8,
                206u8,
                7u8,
        ...
        impl substreams_ethereum::Event for LongTermSwap1To0 {
            const NAME: &'static str = "LongTermSwap1To0";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for LpFeeUpdated {
            const NAME: &'static str = "LpFeeUpdated";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct VirtualOrderExecution {
            pub block_timestamp: substreams::scalar::BigInt,
            pub block_timestamp_elapsed: substreams::scalar::BigInt,
            pub new_reserve0: substreams::scalar::BigInt,
            pub new_reserve1: substreams::scalar::BigInt,
            pub new_twamm_reserve0: substreams::scalar::BigInt,
            pub new_twamm_reserve1: substreams::scalar::BigInt,
            pub token0_bought: substreams::scalar::BigInt,
            pub token1_bought: substreams::scalar::BigInt,
            pub token0_sold: substreams::scalar::BigInt,
            pub token1_sold: substreams::scalar::BigInt,
        }
        impl VirtualOrderExecution {
            const TOPIC_ID: [u8; 32] = [
                121u8,
                62u8,
                232u8,
        ...
        impl substreams_ethereum::Event for VirtualOrderExecution {
            const NAME: &'static str = "VirtualOrderExecution";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct WithdrawProceedsFromLongTermOrder {
            pub addr: Vec<u8>,
            pub order_id: substreams::scalar::BigInt,
            pub proceed_token: Vec<u8>,
            pub proceeds: substreams::scalar::BigInt,
            pub order_expired: bool,
        }
        impl WithdrawProceedsFromLongTermOrder {
            const TOPIC_ID: [u8; 32] = [
                67u8,
                22u8,
                134u8,
            ...
            pub fn decode(
                ...
                Ok(Self {
                    addr: ethabi::decode(
                        ...
                        .as_bytes()
                        .to_vec(),
                    proceed_token: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[2usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'proceed_token' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
        ...
        impl substreams_ethereum::Event for WithdrawProceedsFromLongTermOrder {
            const NAME: &'static str = "WithdrawProceedsFromLongTermOrder";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
