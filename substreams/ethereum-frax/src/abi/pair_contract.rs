...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetNextOrderId {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetTwapHistoryLength {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for LongTermSwapFrom0To1 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for LongTermSwapFrom1To0 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for OrderIDsForUser {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for OrderTimeInterval {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TwammReserve0 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TwammReserve1 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl WithdrawProceedsFromLongTermSwap {
        ...
        pub fn output(data: &[u8]) -> Result<(bool, Vec<u8>, substreams::scalar::BigInt), String> {
            let mut values = ethabi::decode(
                &[
                    ethabi::ParamType::Bool,
                    ethabi::ParamType::Address,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(bool, Vec<u8>, substreams::scalar::BigInt)>
        for WithdrawProceedsFromLongTermSwap
    {
        fn output(data: &[u8]) -> Result<(bool, Vec<u8>, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
}
...
pub mod events {
    ...
    impl CancelLongTermOrder {
        const TOPIC_ID: [u8; 32] = [
            60u8, 93u8, 94u8, 9u8, 71u8, 232u8, 184u8, 5u8, 12u8, 245u8, 62u8, 145u8, 199u8, 73u8,
            109u8, 226u8, 73u8, 157u8, 161u8, 183u8, 97u8, 62u8, 200u8, 107u8, 143u8, 218u8, 135u8,
            5u8, 120u8, 150u8, 99u8, 144u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl LongTermSwap0To1 {
        const TOPIC_ID: [u8; 32] = [
            153u8, 113u8, 41u8, 66u8, 88u8, 183u8, 107u8, 72u8, 16u8, 50u8, 185u8, 193u8, 247u8,
            245u8, 89u8, 70u8, 25u8, 215u8, 207u8, 64u8, 226u8, 158u8, 34u8, 77u8, 233u8, 231u8,
            20u8, 129u8, 189u8, 10u8, 79u8, 133u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl LongTermSwap1To0 {
        const TOPIC_ID: [u8; 32] = [
            225u8, 206u8, 7u8, 38u8, 124u8, 5u8, 177u8, 96u8, 157u8, 59u8, 212u8, 4u8, 108u8,
            163u8, 105u8, 183u8, 78u8, 100u8, 205u8, 43u8, 69u8, 238u8, 131u8, 33u8, 204u8, 199u8,
            151u8, 131u8, 37u8, 44u8, 96u8, 180u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl LpFeeUpdated {
        const TOPIC_ID: [u8; 32] = [
            42u8, 222u8, 63u8, 230u8, 206u8, 196u8, 136u8, 237u8, 155u8, 19u8, 227u8, 111u8, 81u8,
            121u8, 237u8, 251u8, 202u8, 153u8, 152u8, 254u8, 204u8, 89u8, 38u8, 207u8, 87u8, 51u8,
            85u8, 88u8, 103u8, 29u8, 95u8, 149u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl VirtualOrderExecution {
        const TOPIC_ID: [u8; 32] = [
            121u8, 62u8, 232u8, 176u8, 216u8, 2u8, 15u8, 192u8, 66u8, 169u8, 32u8, 96u8, 126u8,
            60u8, 189u8, 55u8, 245u8, 19u8, 44u8, 1u8, 23u8, 134u8, 200u8, 221u8, 16u8, 166u8,
            133u8, 244u8, 65u8, 78u8, 211u8, 129u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl WithdrawProceedsFromLongTermOrder {
        const TOPIC_ID: [u8; 32] = [
            67u8, 22u8, 134u8, 34u8, 221u8, 181u8, 78u8, 216u8, 76u8, 202u8, 211u8, 6u8, 38u8,
            172u8, 231u8, 7u8, 114u8, 53u8, 220u8, 83u8, 28u8, 103u8, 170u8, 246u8, 57u8, 117u8,
            44u8, 69u8, 25u8, 83u8, 84u8, 72u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
