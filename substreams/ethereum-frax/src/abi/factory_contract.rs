...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CreatePair1 {
        pub token_a: Vec<u8>,
        pub token_b: Vec<u8>,
        pub fee: substreams::scalar::BigInt,
    }
    impl CreatePair1 {
        const METHOD_ID: [u8; 4] = [107u8, 96u8, 13u8, 28u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for CreatePair1 {
        const NAME: &'static str = "createPair1";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreatePair1 {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CreatePair2 {
        pub token_a: Vec<u8>,
        pub token_b: Vec<u8>,
    }
    impl CreatePair2 {
    ...
    impl substreams_ethereum::Function for CreatePair2 {
        const NAME: &'static str = "createPair2";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreatePair2 {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl GlobalPause {
        const METHOD_ID: [u8; 4] = [241u8, 45u8, 84u8, 216u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GlobalPause {
        const NAME: &'static str = "globalPause";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for GlobalPause {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ToggleGlobalPause {}
    impl ToggleGlobalPause {
        const METHOD_ID: [u8; 4] = [70u8, 179u8, 249u8, 19u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for ToggleGlobalPause {
        const NAME: &'static str = "toggleGlobalPause";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
