...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ComputeCustomPoolAddress {
        pub deployer: Vec<u8>,
        pub token0: Vec<u8>,
        pub token1: Vec<u8>,
    }
    impl ComputeCustomPoolAddress {
        const METHOD_ID: [u8; 4] = [27u8, 168u8, 157u8, 244u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for ComputeCustomPoolAddress {
        const NAME: &'static str = "computeCustomPoolAddress";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for ComputeCustomPoolAddress {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl ComputePoolAddress {
        const METHOD_ID: [u8; 4] = [216u8, 237u8, 34u8, 65u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl CreateCustomPool {
        const METHOD_ID: [u8; 4] = [219u8, 191u8, 61u8, 180u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for CreateCustomPool {
        const NAME: &'static str = "createCustomPool";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreateCustomPool {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl CreatePool {
        const METHOD_ID: [u8; 4] = [50u8, 25u8, 53u8, 198u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CustomPoolByPair {
        pub param0: Vec<u8>,
        pub param1: Vec<u8>,
        pub param2: Vec<u8>,
    }
    impl CustomPoolByPair {
        const METHOD_ID: [u8; 4] = [35u8, 218u8, 54u8, 204u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for CustomPoolByPair {
        const NAME: &'static str = "customPoolByPair";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CustomPoolByPair {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CustomPoolDeployer {}
    impl CustomPoolDeployer {
        const METHOD_ID: [u8; 4] = [7u8, 129u8, 7u8, 84u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for CustomPoolDeployer {
        const NAME: &'static str = "CUSTOM_POOL_DEPLOYER";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for CustomPoolDeployer {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DefaultConfigurationForPool {}
    impl DefaultConfigurationForPool {
        const METHOD_ID: [u8; 4] = [37u8, 179u8, 85u8, 214u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DefaultConfigurationForPool {
        const NAME: &'static str = "defaultConfigurationForPool";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    > for DefaultConfigurationForPool {
        fn output(
            data: &[u8],
        ) -> Result<
            (
    ...
    impl DefaultFee {
        const METHOD_ID: [u8; 4] = [90u8, 108u8, 114u8, 208u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DefaultFee {
        const NAME: &'static str = "defaultFee";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl DefaultPluginFactory {
        const METHOD_ID: [u8; 4] = [208u8, 173u8, 39u8, 146u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DefaultPluginFactory {
        const NAME: &'static str = "defaultPluginFactory";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DefaultPluginFactory {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct DefaultTickspacing {}
    impl DefaultTickspacing {
        const METHOD_ID: [u8; 4] = [41u8, 188u8, 52u8, 70u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for DefaultTickspacing {
        const NAME: &'static str = "defaultTickspacing";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct HasRoleOrOwner {
        pub role: [u8; 32usize],
        pub account: Vec<u8>,
    }
    impl HasRoleOrOwner {
        const METHOD_ID: [u8; 4] = [232u8, 174u8, 43u8, 105u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for HasRoleOrOwner {
        const NAME: &'static str = "hasRoleOrOwner";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for HasRoleOrOwner {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PoolInitCodeHash {}
    impl PoolInitCodeHash {
        const METHOD_ID: [u8; 4] = [220u8, 111u8, 216u8, 171u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PoolInitCodeHash {
        const NAME: &'static str = "POOL_INIT_CODE_HASH";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for PoolInitCodeHash {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct PoolsAdministratorRole {}
    impl PoolsAdministratorRole {
        const METHOD_ID: [u8; 4] = [181u8, 0u8, 164u8, 139u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PoolsAdministratorRole {
        const NAME: &'static str = "POOLS_ADMINISTRATOR_ROLE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceOwnershipStartTimestamp {}
    impl RenounceOwnershipStartTimestamp {
        const METHOD_ID: [u8; 4] = [8u8, 75u8, 255u8, 249u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for RenounceOwnershipStartTimestamp {
        const NAME: &'static str = "renounceOwnershipStartTimestamp";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for RenounceOwnershipStartTimestamp {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl SetDefaultCommunityFee {
        const METHOD_ID: [u8; 4] = [141u8, 90u8, 135u8, 17u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    pub struct SetDefaultFee {
        pub new_default_fee: substreams::scalar::BigInt,
    }
    impl SetDefaultFee {
        const METHOD_ID: [u8; 4] = [119u8, 50u8, 101u8, 132u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.new_default_fee.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for SetDefaultFee {
        const NAME: &'static str = "setDefaultFee";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetDefaultPluginFactory {
        pub new_default_plugin_factory: Vec<u8>,
    }
    impl SetDefaultPluginFactory {
        const METHOD_ID: [u8; 4] = [41u8, 57u8, 221u8, 151u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            values.reverse();
            Ok(Self {
                new_default_plugin_factory: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
            ...
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.new_default_plugin_factory),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for SetDefaultPluginFactory {
        const NAME: &'static str = "setDefaultPluginFactory";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetDefaultTickspacing {
        pub new_default_tickspacing: substreams::scalar::BigInt,
    }
    impl SetDefaultTickspacing {
        const METHOD_ID: [u8; 4] = [240u8, 148u8, 137u8, 172u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetDefaultTickspacing {
        const NAME: &'static str = "setDefaultTickspacing";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl SetVaultFactory {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.new_vault_factory),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct StartRenounceOwnership {}
    impl StartRenounceOwnership {
        const METHOD_ID: [u8; 4] = [70u8, 147u8, 136u8, 196u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for StartRenounceOwnership {
        const NAME: &'static str = "startRenounceOwnership";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct StopRenounceOwnership {}
    impl StopRenounceOwnership {
        const METHOD_ID: [u8; 4] = [35u8, 138u8, 29u8, 116u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for StopRenounceOwnership {
        const NAME: &'static str = "stopRenounceOwnership";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl VaultFactory {
        const METHOD_ID: [u8; 4] = [216u8, 160u8, 111u8, 115u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for VaultFactory {
        const NAME: &'static str = "vaultFactory";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for VaultFactory {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl substreams_ethereum::Event for CustomPool {
        const NAME: &'static str = "CustomPool";
    ...
    impl substreams_ethereum::Event for DefaultFee {
        const NAME: &'static str = "DefaultFee";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DefaultPluginFactory {
        pub default_plugin_factory_address: Vec<u8>,
    }
    impl DefaultPluginFactory {
        const TOPIC_ID: [u8; 32] = [
            94u8,
        ...
        pub fn decode(
            ...
            values.reverse();
            Ok(Self {
                default_plugin_factory_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
    ...
    impl substreams_ethereum::Event for DefaultPluginFactory {
        const NAME: &'static str = "DefaultPluginFactory";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    impl substreams_ethereum::Event for DefaultTickspacing {
        const NAME: &'static str = "DefaultTickspacing";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceOwnershipFinish {
        pub timestamp: substreams::scalar::BigInt,
    }
    impl RenounceOwnershipFinish {
        const TOPIC_ID: [u8; 32] = [
            162u8,
            66u8,
            3u8,
    ...
    impl substreams_ethereum::Event for RenounceOwnershipFinish {
        const NAME: &'static str = "RenounceOwnershipFinish";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceOwnershipStart {
        pub timestamp: substreams::scalar::BigInt,
        pub finish_timestamp: substreams::scalar::BigInt,
    }
    impl RenounceOwnershipStart {
        const TOPIC_ID: [u8; 32] = [
            205u8,
            96u8,
            245u8,
    ...
    impl substreams_ethereum::Event for RenounceOwnershipStart {
        const NAME: &'static str = "RenounceOwnershipStart";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceOwnershipStop {
        pub timestamp: substreams::scalar::BigInt,
    }
    impl RenounceOwnershipStop {
        const TOPIC_ID: [u8; 32] = [
            162u8,
            73u8,
            41u8,
    ...
    impl substreams_ethereum::Event for RenounceOwnershipStop {
        const NAME: &'static str = "RenounceOwnershipStop";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for VaultFactory {
        const NAME: &'static str = "VaultFactory";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
