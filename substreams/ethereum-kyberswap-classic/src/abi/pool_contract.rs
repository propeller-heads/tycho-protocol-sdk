    ...
    pub mod functions {
        ...
        pub struct AmpBps {}
        impl AmpBps {
            const METHOD_ID: [u8; 4] = [73u8, 56u8, 107u8, 22u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for AmpBps {
            const NAME: &'static str = "ampBps";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTradeInfo {}
        impl GetTradeInfo {
            const METHOD_ID: [u8; 4] = [214u8, 105u8, 64u8, 39u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetTradeInfo {
            const NAME: &'static str = "getTradeInfo";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetVolumeTrendData {}
        impl GetVolumeTrendData {
            const METHOD_ID: [u8; 4] = [13u8, 148u8, 213u8, 11u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetVolumeTrendData {
            const NAME: &'static str = "getVolumeTrendData";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct Initialize {
            pub u_token0: Vec<u8>,
            pub u_token1: Vec<u8>,
            pub u_amp_bps: substreams::scalar::BigInt,
        }
        impl Initialize {
            const METHOD_ID: [u8; 4] = [110u8, 207u8, 43u8, 34u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_amp_bps.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
    ...
    pub mod events {
        ...
        pub struct Swap {
            ...
            pub amount1_out: substreams::scalar::BigInt,
            pub to: Vec<u8>,
            pub fee_in_precision: substreams::scalar::BigInt,
        }
        impl Swap {
            const TOPIC_ID: [u8; 32] = [
                96u8,
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct Sync {
            pub v_reserve0: substreams::scalar::BigInt,
            pub v_reserve1: substreams::scalar::BigInt,
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpdateEma {
            pub short_ema: substreams::scalar::BigInt,
            pub long_ema: substreams::scalar::BigInt,
            pub last_block_volume: substreams::scalar::BigInt,
            pub skip_block: substreams::scalar::BigInt,
        }
        impl UpdateEma {
            const TOPIC_ID: [u8; 32] = [
                150u8,
        ...
        impl substreams_ethereum::Event for UpdateEma {
            const NAME: &'static str = "UpdateEMA";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
