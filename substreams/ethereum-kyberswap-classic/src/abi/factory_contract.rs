    ...
    pub mod functions {
        ...
        pub struct CreatePool {
            pub token_a: Vec<u8>,
            pub token_b: Vec<u8>,
            pub amp_bps: substreams::scalar::BigInt,
        }
        impl CreatePool {
            const METHOD_ID: [u8; 4] = [143u8, 214u8, 72u8, 64u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.amp_bps.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetFeeConfiguration {}
        impl GetFeeConfiguration {
            const METHOD_ID: [u8; 4] = [173u8, 92u8, 178u8, 225u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetFeeConfiguration {
            const NAME: &'static str = "getFeeConfiguration";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetPoolAtIndex {
            pub token0: Vec<u8>,
            pub token1: Vec<u8>,
            pub index: substreams::scalar::BigInt,
        }
        impl GetPoolAtIndex {
            const METHOD_ID: [u8; 4] = [101u8, 218u8, 146u8, 137u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetPoolAtIndex {
            const NAME: &'static str = "getPoolAtIndex";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetPoolAtIndex {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl GetPools {
            const METHOD_ID: [u8; 4] = [91u8, 29u8, 200u8, 111u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetPoolsLength {
            pub token0: Vec<u8>,
            pub token1: Vec<u8>,
        }
        impl GetPoolsLength {
            const METHOD_ID: [u8; 4] = [83u8, 134u8, 51u8, 223u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetPoolsLength {
            const NAME: &'static str = "getPoolsLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetUnamplifiedPool {
            pub param0: Vec<u8>,
            pub param1: Vec<u8>,
        }
        impl GetUnamplifiedPool {
            const METHOD_ID: [u8; 4] = [61u8, 130u8, 73u8, 126u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetUnamplifiedPool {
            const NAME: &'static str = "getUnamplifiedPool";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetUnamplifiedPool {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl IsPool {
            const METHOD_ID: [u8; 4] = [235u8, 120u8, 127u8, 97u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetFeeConfiguration {
            pub u_fee_to: Vec<u8>,
            pub u_government_fee_bps: substreams::scalar::BigInt,
        }
        impl SetFeeConfiguration {
            const METHOD_ID: [u8; 4] = [41u8, 0u8, 144u8, 157u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_government_fee_bps.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for SetFeeConfiguration {
            const NAME: &'static str = "setFeeConfiguration";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        pub struct PoolCreated {
            ...
            pub pool: Vec<u8>,
            pub amp_bps: substreams::scalar::BigInt,
            pub total_pool: substreams::scalar::BigInt,
        }
        impl PoolCreated {
        ...
        pub struct SetFeeConfiguration {
            pub fee_to: Vec<u8>,
            pub government_fee_bps: substreams::scalar::BigInt,
        }
        impl SetFeeConfiguration {
            const TOPIC_ID: [u8; 32] = [
                206u8,
        ...
        impl substreams_ethereum::Event for SetFeeConfiguration {
            const NAME: &'static str = "SetFeeConfiguration";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        impl substreams_ethereum::Event for SetFeeToSetter {
            const NAME: &'static str = "SetFeeToSetter";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
