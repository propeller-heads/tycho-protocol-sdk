            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::String(self.u_network_contract_name.clone()),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_token_contract),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_amount.clone().to_bytes_be() {
        ...
        impl WithdrawToken {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_withdrawal_address),
                        ),
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.u_token_address),
                        ),
            ...
            pub fn decode(
                ...
                Ok(Self {
                    by: ethabi::decode(
                        ...
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'by' from topic of type 'string': {:?}",
                                e
                            )
                        })?
                        .pop()
                ...
                Ok(Self {
                    by: {
                        ...
                        let v = ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'by' from topic of type 'bytes32': {:?}",
                                    e
                                )
                            })?
                            .pop()
                ...
                Ok(Self {
                    ...
                    to: {
                        ...
                        let v = ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'to' from topic of type 'bytes32': {:?}",
                                    e
                                )
                            })?
                            .pop()
