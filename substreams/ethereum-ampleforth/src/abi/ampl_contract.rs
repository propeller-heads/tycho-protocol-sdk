...
pub mod functions {
    ...
    impl Eip712Domain {
        const METHOD_ID: [u8; 4] = [225u8, 177u8, 29u8, 164u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for Eip712Domain {
        const NAME: &'static str = "EIP712_DOMAIN";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for Eip712Domain {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Eip712Revision {
    ...
    impl MonetaryPolicy {
        const METHOD_ID: [u8; 4] = [142u8, 39u8, 215u8, 215u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MonetaryPolicy {
        const NAME: &'static str = "monetaryPolicy";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for MonetaryPolicy {
    ...
    pub struct Rebase {
        ...
        pub supply_delta: substreams::scalar::BigInt,
    }
    impl Rebase {
        const METHOD_ID: [u8; 4] = [122u8, 67u8, 226u8, 63u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.epoch.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Rebase {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetMonetaryPolicy {
        pub monetary_policy: Vec<u8>,
    }
    impl SetMonetaryPolicy {
        const METHOD_ID: [u8; 4] = [139u8, 90u8, 106u8, 8u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.monetary_policy),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl substreams_ethereum::Function for SetMonetaryPolicy {
        const NAME: &'static str = "setMonetaryPolicy";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl TransferAll {
        const METHOD_ID: [u8; 4] = [163u8, 167u8, 231u8, 243u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for TransferAll {
        const NAME: &'static str = "transferAll";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for TransferAll {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl TransferAllFrom {
        const METHOD_ID: [u8; 4] = [132u8, 212u8, 180u8, 16u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for TransferAllFrom {
        const NAME: &'static str = "transferAllFrom";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for TransferAllFrom {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct LogMonetaryPolicyUpdated {
        pub monetary_policy: Vec<u8>,
    }
    impl LogMonetaryPolicyUpdated {
        const TOPIC_ID: [u8; 32] = [
            14u8,
            105u8,
            97u8,
    ...
    impl substreams_ethereum::Event for LogMonetaryPolicyUpdated {
        const NAME: &'static str = "LogMonetaryPolicyUpdated";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                epoch: {
                    ...
                    ethabi::decode(
                        ...
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'epoch' from topic of type 'uint256': {:?}",
                                e
                            )
                        })?
                        .pop()
    ...
    impl substreams_ethereum::Event for LogRebase {
        const NAME: &'static str = "LogRebase";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
