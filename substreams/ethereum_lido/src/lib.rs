...
//                 .filter_map(|log| {
//                     if let Some(event) =
// abi::wsteth_contract::events::Approval::match_and_decode(log) {                         return
// Some(contract::WstethApproval {                             evt_tx_hash:
// Hex(&view.transaction.hash).to_string(),                             evt_index: log.block_index,
...
//                 .filter_map(|log| {
//                     if let Some(event) =
// abi::wsteth_contract::events::Transfer::match_and_decode(log) {                         return
// Some(contract::WstethTransfer {                             evt_tx_hash:
// Hex(&view.transaction.hash).to_string(),                             evt_index: log.block_index,
//                             evt_block_time: Some(blk.timestamp().to_owned()),
//                             evt_block_number: blk.number,
//                             from: event.from,
...
//         .flat_map(|tx| {
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::Approve::match_call(call))                 .filter_map(|call| {
//                     match abi::wsteth_contract::functions::Approve::decode(call) {
//                         Ok(decoded_call) => {
//                             let output_param0 = match
// abi::wsteth_contract::functions::Approve::output(&call.return_data) {
// Ok(output_param0) => {output_param0}                                 Err(_) =>
// Default::default(),                             };
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::DecreaseAllowance::match_call(call))
// .filter_map(|call| {                     match
// abi::wsteth_contract::functions::DecreaseAllowance::decode(call) {
// Ok(decoded_call) => {                             let output_param0 = match
// abi::wsteth_contract::functions::DecreaseAllowance::output(&call.return_data) {
// Ok(output_param0) => {output_param0}                                 Err(_) =>
// Default::default(),                             };
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::IncreaseAllowance::match_call(call))
// .filter_map(|call| {                     match
// abi::wsteth_contract::functions::IncreaseAllowance::decode(call) {
// Ok(decoded_call) => {                             let output_param0 = match
// abi::wsteth_contract::functions::IncreaseAllowance::output(&call.return_data) {
// Ok(output_param0) => {output_param0}                                 Err(_) =>
// Default::default(),                             };
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::Permit::match_call(call))                 .filter_map(|call| {
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::Transfer::match_call(call))                 .filter_map(|call| {
//                     match abi::wsteth_contract::functions::Transfer::decode(call) {
//                         Ok(decoded_call) => {
//                             let output_param0 = match
// abi::wsteth_contract::functions::Transfer::output(&call.return_data) {
// Ok(output_param0) => {output_param0}                                 Err(_) =>
// Default::default(),                             };
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::TransferFrom::match_call(call))
// .filter_map(|call| {                     match
// abi::wsteth_contract::functions::TransferFrom::decode(call) {
// Ok(decoded_call) => {                             let output_param0 = match
// abi::wsteth_contract::functions::TransferFrom::output(&call.return_data) {
// Ok(output_param0) => {output_param0}                                 Err(_) =>
// Default::default(),                             };
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::Unwrap::match_call(call))                 .filter_map(|call| {
...
//             tx.calls.iter()
//                 .filter(|call| call.address == WSTETH_TRACKED_CONTRACT &&
// abi::wsteth_contract::functions::Wrap::match_call(call))                 .filter_map(|call| {
...
//         tables
//             .create_row("wsteth_approval", [("evt_tx_hash",
// evt.evt_tx_hash.to_string()),("evt_index", evt.evt_index.to_string())])
// .set("evt_block_time", evt.evt_block_time.as_ref().unwrap())             .set("evt_block_number",
// evt.evt_block_number)             .set("owner", Hex(&evt.owner).to_string())
...
//         tables
//             .create_row("wsteth_transfer", [("evt_tx_hash",
// evt.evt_tx_hash.to_string()),("evt_index", evt.evt_index.to_string())])
// .set("evt_block_time", evt.evt_block_time.as_ref().unwrap())             .set("evt_block_number",
// evt.evt_block_number)             .set("from", Hex(&evt.from).to_string())
...
//         tables
//             .create_row("wsteth_call_approve", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("amount", BigDecimal::from_str(&call.amount).unwrap())
...
//         tables
//             .create_row("wsteth_call_decrease_allowance", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("output_param0", call.output_param0)
//             .set("spender", Hex(&call.spender).to_string())
...
//         tables
//             .create_row("wsteth_call_increase_allowance", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("added_value",
// BigDecimal::from_str(&call.added_value).unwrap())             .set("output_param0",
// call.output_param0)             .set("spender", Hex(&call.spender).to_string());
//     });
//     calls.wsteth_call_permits.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_permit", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("deadline", BigDecimal::from_str(&call.deadline).unwrap())
...
//         tables
//             .create_row("wsteth_call_transfer", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("amount", BigDecimal::from_str(&call.amount).unwrap())
...
//         tables
//             .create_row("wsteth_call_transfer_from", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("amount", BigDecimal::from_str(&call.amount).unwrap())
...
//         tables
//             .create_row("wsteth_call_unwrap", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("output_param0",
// BigDecimal::from_str(&call.output_param0).unwrap())             .set("u_wst_eth_amount",
// BigDecimal::from_str(&call.u_wst_eth_amount).unwrap());     });
//     calls.wsteth_call_wraps.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_wrap", [("call_tx_hash",
// call.call_tx_hash.to_string()),("call_ordinal", call.call_ordinal.to_string())])
// .set("call_block_time", call.call_block_time.as_ref().unwrap())
// .set("call_block_number", call.call_block_number)             .set("call_success",
// call.call_success)             .set("output_param0",
// BigDecimal::from_str(&call.output_param0).unwrap())             .set("u_st_eth_amount",
// BigDecimal::from_str(&call.u_st_eth_amount).unwrap());     });
// }
...
//     calls.wsteth_call_approves.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_approve", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
...
//     calls.wsteth_call_decrease_allowances.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_decrease_allowance", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_increase_allowances.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_increase_allowance", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_permits.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_permit", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_transfers.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_transfer", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_transfer_froms.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_transfer_from", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_unwraps.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_unwrap", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
//     calls.wsteth_call_wraps.iter().for_each(|call| {
//         tables
//             .create_row("wsteth_call_wrap", format!("{}-{}", call.call_tx_hash,
// call.call_ordinal))             .set("call_tx_hash", &call.call_tx_hash)
//             .set("call_ordinal", call.call_ordinal)
//             .set("call_block_time", call.call_block_time.as_ref().unwrap())
//             .set("call_block_number", call.call_block_number)
...
// #[substreams::handlers::map]
// fn db_out(events: contract::Events, calls: contract::Calls) -> Result<DatabaseChanges,
// substreams::errors::Error> {     // Initialize Database Changes container
...
// #[substreams::handlers::map]
// fn graph_out(events: contract::Events, calls: contract::Calls) -> Result<EntityChanges,
// substreams::errors::Error> {     // Initialize Database Changes container
