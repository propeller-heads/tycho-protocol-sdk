...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for UpdateNormalizer {
...
pub mod events {
    use super::INTERNAL_ERR;
    #[derive(Debug, Clone, PartialEq)]
    pub struct NormalizerUpdated {
        pub new_normalizer_value: substreams::scalar::BigInt,
    }
    impl NormalizerUpdated {
        const TOPIC_ID: [u8; 32] = [
            180u8, 253u8, 231u8, 64u8, 60u8, 0u8, 28u8, 124u8, 222u8, 175u8, 192u8, 195u8, 187u8,
            70u8, 233u8, 114u8, 17u8, 27u8, 126u8, 250u8, 196u8, 232u8, 50u8, 57u8, 140u8, 191u8,
            159u8, 171u8, 225u8, 105u8, 78u8, 217u8,
        ];
    ...
    impl substreams_ethereum::Event for NormalizerUpdated {
        const NAME: &'static str = "NormalizerUpdated";
    ...
    impl Redeemed {
        const TOPIC_ID: [u8; 32] = [
            57u8, 152u8, 188u8, 243u8, 21u8, 218u8, 228u8, 149u8, 61u8, 41u8, 75u8, 60u8, 166u8,
            225u8, 208u8, 7u8, 76u8, 36u8, 154u8, 220u8, 19u8, 107u8, 80u8, 209u8, 255u8, 153u8,
            176u8, 71u8, 83u8, 199u8, 62u8, 127u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
