...
pub mod events {
    ...
    impl CollateralAdded {
        const TOPIC_ID: [u8; 32] = [
            125u8, 176u8, 94u8, 99u8, 214u8, 53u8, 166u8, 140u8, 98u8, 253u8, 127u8, 216u8, 243u8,
            16u8, 122u8, 232u8, 171u8, 88u8, 74u8, 56u8, 62u8, 16u8, 45u8, 27u8, 216u8, 164u8,
            15u8, 76u8, 151u8, 126u8, 70u8, 95u8,
        ];
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CollateralManagerSet {
        pub collateral: Vec<u8>,
        pub manager_data: (Vec<Vec<u8>>, Vec<u8>),
    }
    impl CollateralManagerSet {
        const TOPIC_ID: [u8; 32] = [
            23u8, 74u8, 249u8, 134u8, 132u8, 33u8, 39u8, 124u8, 57u8, 255u8, 48u8, 86u8, 169u8,
            45u8, 6u8, 200u8, 61u8, 116u8, 223u8, 76u8, 127u8, 100u8, 37u8, 138u8, 221u8, 151u8,
            234u8, 43u8, 220u8, 2u8, 45u8, 129u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for CollateralManagerSet {
        const NAME: &'static str = "CollateralManagerSet";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl CollateralRevoked {
        const TOPIC_ID: [u8; 32] = [
            16u8, 216u8, 237u8, 140u8, 186u8, 145u8, 104u8, 133u8, 227u8, 57u8, 203u8, 33u8, 222u8,
            239u8, 179u8, 132u8, 43u8, 63u8, 65u8, 126u8, 172u8, 129u8, 167u8, 243u8, 75u8, 41u8,
            120u8, 180u8, 236u8, 194u8, 4u8, 15u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for CollateralRevoked {
        const NAME: &'static str = "CollateralRevoked";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct CollateralWhitelistStatusUpdated {
        pub collateral: Vec<u8>,
        pub whitelist_data: Vec<u8>,
        pub whitelist_status: substreams::scalar::BigInt,
    }
    impl CollateralWhitelistStatusUpdated {
        const TOPIC_ID: [u8; 32] = [
            25u8, 20u8, 96u8, 199u8, 39u8, 203u8, 238u8, 158u8, 108u8, 70u8, 234u8, 215u8, 192u8,
            28u8, 132u8, 161u8, 254u8, 143u8, 11u8, 153u8, 24u8, 106u8, 243u8, 137u8, 23u8, 172u8,
            87u8, 222u8, 23u8, 230u8, 186u8, 153u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for CollateralWhitelistStatusUpdated {
        const NAME: &'static str = "CollateralWhitelistStatusUpdated";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl OracleSet {
        const TOPIC_ID: [u8; 32] = [
            186u8, 17u8, 50u8, 156u8, 11u8, 15u8, 152u8, 185u8, 28u8, 37u8, 71u8, 85u8, 170u8,
            141u8, 105u8, 143u8, 234u8, 195u8, 180u8, 111u8, 171u8, 101u8, 182u8, 95u8, 229u8,
            171u8, 117u8, 112u8, 222u8, 47u8, 249u8, 40u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for OracleSet {
        const NAME: &'static str = "OracleSet";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl Recovered {
        const TOPIC_ID: [u8; 32] = [
            255u8, 243u8, 179u8, 132u8, 66u8, 118u8, 245u8, 112u8, 36u8, 224u8, 180u8, 42u8, 254u8,
            193u8, 163u8, 127u8, 117u8, 219u8, 54u8, 81u8, 30u8, 67u8, 129u8, 154u8, 79u8, 42u8,
            99u8, 171u8, 120u8, 98u8, 182u8, 72u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl substreams_ethereum::Event for Recovered {
        const NAME: &'static str = "Recovered";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ReservesAdjusted {
        pub collateral: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
        pub increase: bool,
    }
    impl ReservesAdjusted {
        const TOPIC_ID: [u8; 32] = [
            35u8, 71u8, 226u8, 25u8, 235u8, 110u8, 131u8, 230u8, 49u8, 82u8, 235u8, 145u8, 125u8,
            219u8, 29u8, 249u8, 25u8, 192u8, 249u8, 32u8, 143u8, 169u8, 29u8, 218u8, 11u8, 209u8,
            72u8, 34u8, 198u8, 190u8, 29u8, 7u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for ReservesAdjusted {
        const NAME: &'static str = "ReservesAdjusted";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TrustedToggled {
        pub sender: Vec<u8>,
        pub is_trusted: bool,
        pub trusted_type: substreams::scalar::BigInt,
    }
    impl TrustedToggled {
        const TOPIC_ID: [u8; 32] = [
            246u8, 89u8, 201u8, 163u8, 12u8, 65u8, 99u8, 140u8, 105u8, 109u8, 100u8, 182u8, 232u8,
            204u8, 30u8, 232u8, 255u8, 245u8, 67u8, 233u8, 115u8, 255u8, 193u8, 233u8, 226u8,
            215u8, 148u8, 34u8, 90u8, 224u8, 23u8, 138u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            let mut values = ethabi::decode(
                &[ethabi::ParamType::Bool, ethabi::ParamType::Uint(8usize)],
                log.data.as_ref(),
            )
            .map_err(|e| format!("unable to decode log.data: {:?}", e))?;
            values.reverse();
    ...
    impl substreams_ethereum::Event for TrustedToggled {
        const NAME: &'static str = "TrustedToggled";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
