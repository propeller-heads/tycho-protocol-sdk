    ...
    pub mod functions {
        ...
        impl substreams_ethereum::Function for CancelAuthorization1 {
            const NAME: &'static str = "cancelAuthorization1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for CancelAuthorization2 {
            const NAME: &'static str = "cancelAuthorization2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for ReceiveWithAuthorization1 {
            const NAME: &'static str = "receiveWithAuthorization1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for ReceiveWithAuthorization2 {
            const NAME: &'static str = "receiveWithAuthorization2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for TransferWithAuthorization1 {
            const NAME: &'static str = "transferWithAuthorization1";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::Function for TransferWithAuthorization2 {
            const NAME: &'static str = "transferWithAuthorization2";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl UpdateRescuer {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.new_rescuer),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
