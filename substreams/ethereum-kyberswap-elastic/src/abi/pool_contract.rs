...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetFeeGrowthGlobal {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl GetPositions {
        ...
        pub fn output(
            ...
            let mut values = ethabi::decode(
                &[ethabi::ParamType::Uint(128usize), ethabi::ParamType::Uint(256usize)],
                data.as_ref(),
            )
            .map_err(|e| format!("unable to decode output data: {:?}", e))?;
            values.reverse();
    ...
    impl GetSecondsPerLiquidityData {
        ...
        pub fn output(
            ...
            let mut values = ethabi::decode(
                &[ethabi::ParamType::Uint(128usize), ethabi::ParamType::Uint(32usize)],
                data.as_ref(),
            )
            .map_err(|e| format!("unable to decode output data: {:?}", e))?;
            values.reverse();
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxTickLiquidity {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for SwapFeeUnits {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TickDistance {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TweakPosZeroLiq {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl BurnRTokens {
        const TOPIC_ID: [u8; 32] = [
            50u8, 68u8, 135u8, 201u8, 154u8, 31u8, 127u8, 14u8, 49u8, 39u8, 73u8, 154u8, 84u8,
            132u8, 82u8, 211u8, 161u8, 152u8, 231u8, 140u8, 205u8, 7u8, 173u8, 217u8, 19u8, 203u8,
            147u8, 213u8, 159u8, 15u8, 3u8, 155u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
