...
fn main() -> Result<(), anyhow::Error> {
    let file_names = ["abi/elasticfactory_contract.abi.json", "abi/pool_contract.abi.json"];
    let file_output_names = ["src/abi/elasticfactory_contract.rs", "src/abi/pool_contract.rs"];
