...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxFeePercent {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DrainWrongToken {
        pub token: Vec<u8>,
        pub to: Vec<u8>,
    }
    impl DrainWrongToken {
        const METHOD_ID: [u8; 4] = [243u8, 154u8, 193u8, 31u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for DrainWrongToken {
        const NAME: &'static str = "drainWrongToken";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PairTypeImmutable {}
    impl PairTypeImmutable {
        const METHOD_ID: [u8; 4] = [182u8, 32u8, 11u8, 7u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for PairTypeImmutable {
        const NAME: &'static str = "pairTypeImmutable";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for PairTypeImmutable {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PrecisionMultiplier0 {}
    impl PrecisionMultiplier0 {
        const METHOD_ID: [u8; 4] = [59u8, 159u8, 29u8, 192u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for PrecisionMultiplier0 {
        const NAME: &'static str = "precisionMultiplier0";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for PrecisionMultiplier0 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct PrecisionMultiplier1 {}
    impl PrecisionMultiplier1 {
        const METHOD_ID: [u8; 4] = [40u8, 142u8, 93u8, 2u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for PrecisionMultiplier1 {
        const NAME: &'static str = "precisionMultiplier1";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for PrecisionMultiplier1 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetFeePercent {
        pub new_token0_fee_percent: substreams::scalar::BigInt,
        pub new_token1_fee_percent: substreams::scalar::BigInt,
    }
    impl SetFeePercent {
        const METHOD_ID: [u8; 4] = [72u8, 229u8, 210u8, 96u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetFeePercent {
        const NAME: &'static str = "setFeePercent";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetPairTypeImmutable {}
    impl SetPairTypeImmutable {
        const METHOD_ID: [u8; 4] = [59u8, 161u8, 112u8, 119u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for SetPairTypeImmutable {
        const NAME: &'static str = "setPairTypeImmutable";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetStableSwap {
        pub stable: bool,
        pub expected_reserve0: substreams::scalar::BigInt,
        pub expected_reserve1: substreams::scalar::BigInt,
    }
    impl SetStableSwap {
        const METHOD_ID: [u8; 4] = [48u8, 41u8, 229u8, 212u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetStableSwap {
        const NAME: &'static str = "setStableSwap";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl StableSwap {
        const METHOD_ID: [u8; 4] = [158u8, 84u8, 139u8, 127u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for StableSwap {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for StableSwap {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl Swap2 {
        const METHOD_ID: [u8; 4] = [110u8, 31u8, 221u8, 127u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Token0FeePercent {}
    impl Token0FeePercent {
        const METHOD_ID: [u8; 4] = [98u8, 236u8, 236u8, 3u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Token0FeePercent {
        const NAME: &'static str = "token0FeePercent";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Token0FeePercent {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Token1FeePercent {}
    impl Token1FeePercent {
        const METHOD_ID: [u8; 4] = [47u8, 205u8, 22u8, 146u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Token1FeePercent {
        const NAME: &'static str = "token1FeePercent";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Token1FeePercent {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl DrainWrongToken {
        const TOPIC_ID: [u8; 32] = [
            54u8, 138u8, 157u8, 200u8, 99u8, 236u8, 185u8, 75u8, 91u8, 163u8, 42u8, 104u8, 46u8,
            38u8, 41u8, 91u8, 16u8, 217u8, 194u8, 102u8, 111u8, 173u8, 125u8, 120u8, 94u8, 189u8,
            242u8, 98u8, 195u8, 197u8, 36u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for DrainWrongToken {
        const NAME: &'static str = "DrainWrongToken";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    pub struct FeePercentUpdated {
        pub token0_fee_percent: substreams::scalar::BigInt,
        pub token1_fee_percent: substreams::scalar::BigInt,
    }
    impl FeePercentUpdated {
        const TOPIC_ID: [u8; 32] = [
            164u8, 135u8, 123u8, 142u8, 203u8, 90u8, 0u8, 186u8, 39u8, 126u8, 75u8, 206u8, 238u8,
            177u8, 135u8, 166u8, 105u8, 231u8, 17u8, 54u8, 73u8, 119u8, 77u8, 251u8, 234u8, 5u8,
            194u8, 89u8, 206u8, 39u8, 241u8, 123u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for FeePercentUpdated {
        const NAME: &'static str = "FeePercentUpdated";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl SetPairTypeImmutable {
        const TOPIC_ID: [u8; 32] = [
            9u8, 18u8, 44u8, 65u8, 174u8, 115u8, 58u8, 77u8, 119u8, 64u8, 50u8, 77u8, 80u8, 227u8,
            95u8, 189u8, 110u8, 232u8, 91u8, 227u8, 193u8, 49u8, 42u8, 69u8, 89u8, 109u8, 128u8,
            69u8, 21u8, 10u8, 178u8, 242u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for SetPairTypeImmutable {
        const NAME: &'static str = "SetPairTypeImmutable";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetStableSwap {
        pub prev_stable_swap: bool,
        pub stable_swap: bool,
    }
    impl SetStableSwap {
        const TOPIC_ID: [u8; 32] = [
            182u8, 168u8, 103u8, 16u8, 189u8, 229u8, 58u8, 167u8, 251u8, 27u8, 56u8, 86u8, 39u8,
            158u8, 42u8, 245u8, 180u8, 118u8, 213u8, 62u8, 45u8, 208u8, 144u8, 44u8, 241u8, 122u8,
            9u8, 17u8, 181u8, 164u8, 58u8, 139u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for SetStableSwap {
        const NAME: &'static str = "SetStableSwap";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
    ...
    impl Skim {
        const TOPIC_ID: [u8; 32] = [
            33u8, 173u8, 34u8, 73u8, 92u8, 156u8, 117u8, 205u8, 28u8, 148u8, 117u8, 111u8, 145u8,
            130u8, 78u8, 119u8, 156u8, 12u8, 138u8, 142u8, 22u8, 139u8, 38u8, 124u8, 121u8, 13u8,
            244u8, 100u8, 254u8, 5u8, 107u8, 121u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for Skim {
        const NAME: &'static str = "Skim";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
