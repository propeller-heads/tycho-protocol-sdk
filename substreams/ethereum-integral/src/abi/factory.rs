    ...
    pub mod functions {
        ...
        impl Collect {
            const METHOD_ID: [u8; 4] = [102u8, 144u8, 2u8, 83u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl CreatePair {
            const METHOD_ID: [u8; 4] = [77u8, 168u8, 238u8, 176u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetBurnFee {
            const METHOD_ID: [u8; 4] = [219u8, 200u8, 241u8, 44u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetMintFee {
            const METHOD_ID: [u8; 4] = [79u8, 224u8, 233u8, 47u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetOracle {
            const METHOD_ID: [u8; 4] = [12u8, 20u8, 69u8, 129u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetSwapFee {
            const METHOD_ID: [u8; 4] = [203u8, 57u8, 233u8, 203u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetTrader {
            const METHOD_ID: [u8; 4] = [136u8, 83u8, 135u8, 21u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl Withdraw {
            const METHOD_ID: [u8; 4] = [14u8, 145u8, 127u8, 118u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
