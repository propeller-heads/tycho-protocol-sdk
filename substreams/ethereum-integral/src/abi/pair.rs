    ...
    pub mod functions {
        ...
        pub struct BurnFee {}
        impl BurnFee {
            const METHOD_ID: [u8; 4] = [252u8, 229u8, 137u8, 216u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for BurnFee {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetDepositAmount0In {
            pub amount0: substreams::scalar::BigInt,
            pub data: Vec<u8>,
        }
        impl GetDepositAmount0In {
            const METHOD_ID: [u8; 4] = [56u8, 176u8, 127u8, 2u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetDepositAmount0In {
            const NAME: &'static str = "getDepositAmount0In";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetDepositAmount0In {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetDepositAmount1In {
            pub amount1: substreams::scalar::BigInt,
            pub data: Vec<u8>,
        }
        impl GetDepositAmount1In {
            const METHOD_ID: [u8; 4] = [149u8, 197u8, 223u8, 149u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetDepositAmount1In {
            const NAME: &'static str = "getDepositAmount1In";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct GetFees {}
        impl GetFees {
            const METHOD_ID: [u8; 4] = [219u8, 141u8, 85u8, 241u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetSwapAmount0In {
            pub amount1_out: substreams::scalar::BigInt,
            pub data: Vec<u8>,
        }
        impl GetSwapAmount0In {
            const METHOD_ID: [u8; 4] = [199u8, 72u8, 27u8, 143u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetSwapAmount0In {
            const NAME: &'static str = "getSwapAmount0In";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetSwapAmount0Out {
            const METHOD_ID: [u8; 4] = [10u8, 229u8, 245u8, 180u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetSwapAmount1In {
            pub amount0_out: substreams::scalar::BigInt,
            pub data: Vec<u8>,
        }
        impl GetSwapAmount1In {
            const METHOD_ID: [u8; 4] = [214u8, 148u8, 93u8, 137u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetSwapAmount1In {
            const NAME: &'static str = "getSwapAmount1In";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetSwapAmount1Out {
            const METHOD_ID: [u8; 4] = [43u8, 155u8, 1u8, 93u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.token1),
                        ),
                        ethabi::Token::Address(
        ...
        pub struct MintFee {}
        impl MintFee {
            const METHOD_ID: [u8; 4] = [19u8, 150u8, 109u8, 181u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MintFee {
            const NAME: &'static str = "mintFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetBurnFee {
            pub fee: substreams::scalar::BigInt,
        }
        impl SetBurnFee {
            const METHOD_ID: [u8; 4] = [75u8, 242u8, 199u8, 201u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetBurnFee {
            const NAME: &'static str = "setBurnFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetMintFee {
            pub fee: substreams::scalar::BigInt,
        }
        impl SetMintFee {
            const METHOD_ID: [u8; 4] = [237u8, 221u8, 13u8, 156u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetMintFee {
            const NAME: &'static str = "setMintFee";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetTrader {
            pub trader: Vec<u8>,
        }
        impl SetTrader {
            const METHOD_ID: [u8; 4] = [166u8, 188u8, 24u8, 249u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetTrader {
            const NAME: &'static str = "setTrader";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct SwapFee {}
        impl SwapFee {
            const METHOD_ID: [u8; 4] = [84u8, 207u8, 42u8, 235u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        pub struct Trader {}
        impl Trader {
            const METHOD_ID: [u8; 4] = [23u8, 88u8, 7u8, 139u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Trader {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Trader {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        ...
        pub struct Burn {
            ...
            pub amount0_out: substreams::scalar::BigInt,
            pub amount1_out: substreams::scalar::BigInt,
            pub liquidity_in: substreams::scalar::BigInt,
            pub to: Vec<u8>,
        }
        impl Burn {
            const TOPIC_ID: [u8; 32] = [
        ...
        pub struct Mint {
            ...
            pub amount0_in: substreams::scalar::BigInt,
            pub amount1_in: substreams::scalar::BigInt,
            pub liquidity_out: substreams::scalar::BigInt,
            pub to: Vec<u8>,
        }
        impl Mint {
            const TOPIC_ID: [u8; 32] = [
        ...
        impl substreams_ethereum::Event for SetBurnFee {
            const NAME: &'static str = "SetBurnFee";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        impl substreams_ethereum::Event for SetMintFee {
            const NAME: &'static str = "SetMintFee";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        impl substreams_ethereum::Event for SetSwapFee {
            const NAME: &'static str = "SetSwapFee";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
        ...
        impl substreams_ethereum::Event for SetTrader {
            const NAME: &'static str = "SetTrader";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
