...
pub mod functions {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Tuple(vec![
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.1.clone().to_bytes_be() {
                ...
                ethabi::Token::Bool(self.i.2.clone()),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.3.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.4.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.5.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.6.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.7.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.8.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.9.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.10.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.11.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.12.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.13.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.14.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.i.15.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
    ...
    impl PauseUser {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(
                &[ethabi::ParamType::Address, ethabi::ParamType::Bool, ethabi::ParamType::Bool],
                maybe_data.unwrap(),
            )
            .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
...
pub mod events {
    ...
    impl LogInitializePoolConfig {
        const TOPIC_ID: [u8; 32] = [
            162u8, 189u8, 136u8, 18u8, 76u8, 108u8, 239u8, 95u8, 144u8, 92u8, 141u8, 232u8, 58u8,
            227u8, 27u8, 116u8, 149u8, 70u8, 155u8, 231u8, 164u8, 79u8, 10u8, 20u8, 236u8, 118u8,
            110u8, 79u8, 41u8, 38u8, 185u8, 228u8,
        ];
    ...
    impl LogInitializePriceParams {
        const TOPIC_ID: [u8; 32] = [
            77u8, 248u8, 241u8, 254u8, 96u8, 170u8, 55u8, 97u8, 10u8, 169u8, 165u8, 242u8, 149u8,
            139u8, 17u8, 198u8, 52u8, 194u8, 178u8, 49u8, 121u8, 114u8, 19u8, 234u8, 21u8, 6u8,
            156u8, 210u8, 20u8, 191u8, 183u8, 136u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogPauseSwapAndArbitrage {
        const TOPIC_ID: [u8; 32] = [
            132u8, 3u8, 157u8, 164u8, 19u8, 11u8, 150u8, 239u8, 15u8, 160u8, 255u8, 250u8, 27u8,
            177u8, 48u8, 108u8, 129u8, 73u8, 19u8, 112u8, 47u8, 99u8, 237u8, 226u8, 209u8, 203u8,
            205u8, 250u8, 67u8, 252u8, 103u8, 214u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogPauseUser {
        const TOPIC_ID: [u8; 32] = [
            231u8, 133u8, 230u8, 212u8, 249u8, 241u8, 50u8, 28u8, 108u8, 141u8, 89u8, 115u8, 133u8,
            255u8, 78u8, 188u8, 255u8, 74u8, 89u8, 125u8, 89u8, 172u8, 57u8, 17u8, 181u8, 5u8,
            47u8, 191u8, 128u8, 94u8, 182u8, 201u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogRescueFunds {
        const TOPIC_ID: [u8; 32] = [
            223u8, 242u8, 163u8, 148u8, 123u8, 207u8, 159u8, 192u8, 128u8, 123u8, 20u8, 46u8,
            124u8, 132u8, 151u8, 6u8, 109u8, 185u8, 24u8, 52u8, 40u8, 183u8, 189u8, 191u8, 177u8,
            252u8, 208u8, 245u8, 92u8, 39u8, 163u8, 223u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogToggleOracleActivation {
        const TOPIC_ID: [u8; 32] = [
            106u8, 197u8, 6u8, 195u8, 71u8, 128u8, 254u8, 52u8, 100u8, 210u8, 187u8, 40u8, 97u8,
            218u8, 87u8, 38u8, 207u8, 21u8, 178u8, 225u8, 228u8, 41u8, 97u8, 170u8, 2u8, 131u8,
            210u8, 98u8, 137u8, 35u8, 18u8, 93u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogTurnOnSmartCol {
        const TOPIC_ID: [u8; 32] = [
            165u8, 107u8, 55u8, 179u8, 237u8, 249u8, 225u8, 55u8, 156u8, 164u8, 8u8, 229u8, 140u8,
            29u8, 77u8, 133u8, 208u8, 58u8, 167u8, 81u8, 193u8, 221u8, 139u8, 118u8, 250u8, 152u8,
            19u8, 191u8, 178u8, 249u8, 121u8, 61u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogTurnOnSmartDebt {
        const TOPIC_ID: [u8; 32] = [
            23u8, 29u8, 220u8, 9u8, 45u8, 127u8, 67u8, 80u8, 37u8, 203u8, 72u8, 53u8, 202u8, 88u8,
            39u8, 100u8, 18u8, 96u8, 232u8, 242u8, 211u8, 127u8, 252u8, 72u8, 172u8, 164u8, 131u8,
            101u8, 9u8, 183u8, 157u8, 80u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUnpauseSwapAndArbitrage {
        const TOPIC_ID: [u8; 32] = [
            102u8, 82u8, 39u8, 253u8, 239u8, 93u8, 213u8, 170u8, 200u8, 16u8, 134u8, 194u8, 48u8,
            31u8, 14u8, 80u8, 103u8, 108u8, 53u8, 28u8, 248u8, 218u8, 15u8, 69u8, 109u8, 226u8,
            194u8, 195u8, 225u8, 100u8, 9u8, 222u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUnpauseUser {
        const TOPIC_ID: [u8; 32] = [
            175u8, 62u8, 234u8, 81u8, 98u8, 217u8, 21u8, 236u8, 165u8, 50u8, 136u8, 28u8, 164u8,
            30u8, 26u8, 82u8, 146u8, 189u8, 162u8, 148u8, 127u8, 233u8, 71u8, 17u8, 202u8, 211u8,
            180u8, 187u8, 38u8, 11u8, 87u8, 240u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateCenterPriceAddress {
        const TOPIC_ID: [u8; 32] = [
            6u8, 2u8, 9u8, 32u8, 211u8, 176u8, 199u8, 99u8, 112u8, 133u8, 59u8, 114u8, 52u8, 117u8,
            19u8, 153u8, 1u8, 3u8, 154u8, 14u8, 13u8, 138u8, 43u8, 68u8, 43u8, 47u8, 197u8, 5u8,
            135u8, 168u8, 4u8, 117u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateCenterPriceLimits {
        const TOPIC_ID: [u8; 32] = [
            212u8, 67u8, 98u8, 81u8, 165u8, 181u8, 44u8, 33u8, 198u8, 128u8, 165u8, 138u8, 12u8,
            24u8, 157u8, 173u8, 35u8, 142u8, 49u8, 80u8, 170u8, 162u8, 132u8, 135u8, 98u8, 183u8,
            104u8, 7u8, 224u8, 0u8, 208u8, 214u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateFeeAndRevenueCut {
        const TOPIC_ID: [u8; 32] = [
            135u8, 8u8, 194u8, 162u8, 187u8, 186u8, 4u8, 232u8, 233u8, 199u8, 68u8, 140u8, 214u8,
            77u8, 193u8, 9u8, 179u8, 103u8, 52u8, 31u8, 85u8, 4u8, 169u8, 131u8, 95u8, 251u8, 94u8,
            125u8, 154u8, 224u8, 142u8, 246u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateHookAddress {
        const TOPIC_ID: [u8; 32] = [
            148u8, 16u8, 42u8, 157u8, 97u8, 98u8, 71u8, 108u8, 49u8, 55u8, 217u8, 253u8, 103u8,
            214u8, 31u8, 172u8, 170u8, 163u8, 148u8, 140u8, 246u8, 191u8, 132u8, 238u8, 24u8, 53u8,
            122u8, 29u8, 91u8, 140u8, 141u8, 103u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateMaxBorrowShares {
        const TOPIC_ID: [u8; 32] = [
            18u8, 2u8, 62u8, 249u8, 212u8, 71u8, 201u8, 132u8, 140u8, 251u8, 212u8, 123u8, 150u8,
            164u8, 108u8, 2u8, 200u8, 164u8, 210u8, 116u8, 191u8, 243u8, 117u8, 210u8, 24u8, 89u8,
            197u8, 76u8, 250u8, 106u8, 201u8, 161u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateMaxSupplyShares {
        const TOPIC_ID: [u8; 32] = [
            192u8, 136u8, 200u8, 38u8, 105u8, 173u8, 71u8, 214u8, 77u8, 68u8, 135u8, 199u8, 114u8,
            232u8, 106u8, 236u8, 161u8, 174u8, 94u8, 66u8, 47u8, 190u8, 147u8, 133u8, 50u8, 69u8,
            169u8, 72u8, 1u8, 23u8, 103u8, 227u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateRangePercents {
        const TOPIC_ID: [u8; 32] = [
            78u8, 184u8, 71u8, 226u8, 144u8, 159u8, 213u8, 199u8, 37u8, 176u8, 24u8, 215u8, 158u8,
            24u8, 115u8, 155u8, 173u8, 251u8, 51u8, 186u8, 138u8, 166u8, 89u8, 38u8, 251u8, 162u8,
            198u8, 68u8, 195u8, 204u8, 90u8, 142u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateThresholdPercent {
        const TOPIC_ID: [u8; 32] = [
            219u8, 50u8, 102u8, 72u8, 150u8, 218u8, 229u8, 105u8, 101u8, 64u8, 228u8, 114u8, 239u8,
            115u8, 208u8, 132u8, 177u8, 15u8, 175u8, 121u8, 165u8, 86u8, 4u8, 112u8, 189u8, 136u8,
            211u8, 77u8, 174u8, 233u8, 36u8, 1u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateUserBorrowConfigs {
        const TOPIC_ID: [u8; 32] = [
            206u8, 147u8, 56u8, 150u8, 246u8, 232u8, 194u8, 160u8, 91u8, 146u8, 205u8, 127u8,
            133u8, 76u8, 216u8, 46u8, 105u8, 173u8, 169u8, 229u8, 51u8, 207u8, 67u8, 134u8, 67u8,
            213u8, 211u8, 167u8, 172u8, 156u8, 186u8, 157u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateUserSupplyConfigs {
        const TOPIC_ID: [u8; 32] = [
            214u8, 128u8, 17u8, 120u8, 40u8, 241u8, 108u8, 167u8, 57u8, 21u8, 6u8, 23u8, 252u8,
            97u8, 227u8, 38u8, 249u8, 126u8, 77u8, 149u8, 129u8, 214u8, 27u8, 88u8, 153u8, 33u8,
            83u8, 185u8, 44u8, 116u8, 252u8, 115u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateUserWithdrawalLimit {
        const TOPIC_ID: [u8; 32] = [
            160u8, 23u8, 78u8, 199u8, 225u8, 61u8, 225u8, 197u8, 149u8, 77u8, 210u8, 112u8, 214u8,
            125u8, 175u8, 206u8, 173u8, 220u8, 46u8, 124u8, 104u8, 93u8, 93u8, 173u8, 160u8, 1u8,
            91u8, 139u8, 181u8, 31u8, 178u8, 216u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl LogUpdateUtilizationLimit {
        const TOPIC_ID: [u8; 32] = [
            109u8, 102u8, 25u8, 8u8, 112u8, 245u8, 164u8, 1u8, 189u8, 47u8, 36u8, 5u8, 108u8, 79u8,
            114u8, 26u8, 122u8, 158u8, 82u8, 37u8, 1u8, 234u8, 34u8, 42u8, 20u8, 11u8, 188u8, 45u8,
            235u8, 211u8, 2u8, 205u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
