...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct AdminActionDeadline {}
    impl AdminActionDeadline {
        const METHOD_ID: [u8; 4] = [230u8, 111u8, 67u8, 245u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for AdminActionDeadline {
        const NAME: &'static str = "admin_action_deadline";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl CommitNewFee {
        const METHOD_ID: [u8; 4] = [164u8, 142u8, 172u8, 157u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    pub struct EmaPrice {}
    impl EmaPrice {
        const METHOD_ID: [u8; 4] = [194u8, 76u8, 124u8, 41u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    pub struct GetP {}
    impl GetP {
        const METHOD_ID: [u8; 4] = [242u8, 56u8, 138u8, 203u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetP {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Initialize {
        ...
        pub rate_multipliers: [substreams::scalar::BigInt; 4usize],
        pub a: substreams::scalar::BigInt,
        pub fee: substreams::scalar::BigInt,
    }
    impl Initialize {
        const METHOD_ID: [u8; 4] = [164u8, 97u8, 179u8, 200u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl LastPrice {
        const METHOD_ID: [u8; 4] = [253u8, 230u8, 37u8, 230u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl OracleMethod {
        const METHOD_ID: [u8; 4] = [52u8, 149u8, 1u8, 141u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for OracleMethod {
        const NAME: &'static str = "oracle_method";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl SetMaExpTime {
        const METHOD_ID: [u8; 4] = [127u8, 62u8, 23u8, 203u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl SetOracle {
        const METHOD_ID: [u8; 4] = [209u8, 210u8, 77u8, 73u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            let mut values = ethabi::decode(
                    &[ethabi::ParamType::FixedBytes(4usize), ethabi::ParamType::Address],
                    maybe_data.unwrap(),
                )
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
    ...
    impl substreams_ethereum::Function for SetOracle {
        const NAME: &'static str = "set_oracle";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
