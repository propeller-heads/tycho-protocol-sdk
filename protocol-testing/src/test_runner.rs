...
static CLONE_TO_BASE_PROTOCOL: LazyLock<HashMap<&str, &str>> = LazyLock::new(|| {
    HashMap::from([
        ...
        // UniV2 fork factories
        ("ethereum-univ2-fork-115934-v2", "ethereum-uniswap-v2"),
        ("ethereum-nineinch-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-5d8d3b-v2", "ethereum-uniswap-v2"),
        ("ethereum-fraxswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-swaps-v2", "ethereum-uniswap-v2"),
        ("ethereum-linkswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-crodefi-swap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-644b39-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-a206f6-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-bc67c8-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-41060a-v2", "ethereum-uniswap-v2"),
        ("ethereum-oboswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-proxy-8ff485-v2", "ethereum-uniswap-v2"),
        ("ethereum-orionpool-v2", "ethereum-uniswap-v2"),
        ("ethereum-youswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-jmswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-2f3db9-v2", "ethereum-uniswap-v2"),
        ("ethereum-kingswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-kwikswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-1e2c21-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-880ae0-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-0388c1-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-229457-v2", "ethereum-uniswap-v2"),
        ("ethereum-saitaswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-3823ac-v2", "ethereum-uniswap-v2"),
        ("ethereum-hiswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-pepedex-v2", "ethereum-uniswap-v2"),
        ("ethereum-yape-v2", "ethereum-uniswap-v2"),
        ("ethereum-swapfactory-4eef57-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-5bddc6-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-proxy-69bd16-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-6c3d18-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-7386f6-v2", "ethereum-uniswap-v2"),
        ("ethereum-sakeswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-7dda55-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-8a93b6-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-8f9f4c-v2", "ethereum-uniswap-v2"),
        ("ethereum-sumswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-safeswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-mintyswap-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-a40ec8-v2", "ethereum-uniswap-v2"),
        ("ethereum-univ2-fork-e1046f-v2", "ethereum-uniswap-v2"),
